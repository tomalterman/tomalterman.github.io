...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function zo(e,t,n){let r=new Float32Array(To),i=new G(0,1,0);return new sa({name:`SphericalGaussianBlur`,defines:{n:To,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Ho(),fragmentShader:`
	...
	`}var Uo=class extends Gt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new hi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=oc(i,i.VERTEX_SHADER,y),S=oc(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.morphTargets===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1)if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=fc(i,x,`vertex`),n=fc(i,S,`fragment`);H(`THREE.WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
}`,vl=class{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){let n=new vi(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=n}}getMesh(e){if(this.texture!==null&&this.mesh===null){let t=e.cameras[0].viewport,n=new sa({vertexShader:gl,fragmentShader:_l,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new Y(new Zi(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}},yl=class extends $e{constructor(e,t){super();let n=this,r=null,i=1,a=null,o=`local-floor`,s=1,c=null,u=null,d=null,f=null,p=null,h=null,g=typeof XRWebGLBinding<`u`,_=new vl,v={},b=t.getContextAttributes(),x=null,S=null,C=[],D=[],ee=new W,O=null,k=new Va;k.viewport=new Ut;let te=new Va;te.viewport=new Ut;let A=[k,te],j=new Xa,ne=null,re=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(e){let t=C[e];return t===void 0&&(t=new Tn,C[e]=t),t.getTargetRaySpace()},this.getControllerGrip=function(e){let t=C[e];return t===void 0&&(t=new Tn,C[e]=t),t.getGripSpace()},this.getHand=function(e){let t=C[e];return t===void 0&&(t=new Tn,C[e]=t),t.getHandSpace()};function M(e){let t=D.indexOf(e.inputSource);if(t===-1)return;let n=C[t];n!==void 0&&(n.update(e.inputSource,e.frame,c||a),n.dispatchEvent({type:e.type,data:e.inputSource}))}function ie(){r.removeEventListener(`select`,M),r.removeEventListener(`selectstart`,M),r.removeEventListener(`selectend`,M),r.removeEventListener(`squeeze`,M),r.removeEventListener(`squeezestart`,M),r.removeEventListener(`squeezeend`,M),r.removeEventListener(`end`,ie),r.removeEventListener(`inputsourceschange`,ae);for(let e=0;e<C.length;e++){let t=D[e];t!==null&&(D[e]=null,C[e].disconnect(t))}ne=null,re=null,_.reset();for(let e in v)delete v[e];e.setRenderTarget(x),p=null,f=null,d=null,r=null,S=null,de.stop(),n.isPresenting=!1,e.setPixelRatio(O),e.setSize(ee.width,ee.height,!1),n.dispatchEvent({type:`sessionend`})}this.setFramebufferScaleFactor=function(e){i=e,n.isPresenting===!0&&V(`WebXRManager: Cannot change framebuffer scale while presenting.`)},this.setReferenceSpaceType=function(e){o=e,n.isPresenting===!0&&V(`WebXRManager: Cannot change reference space type while presenting.`)},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(e){c=e},this.getBaseLayer=function(){return f===null?p:f},this.getBinding=function(){return d===null&&g&&(d=new XRWebGLBinding(r,t)),d},this.getFrame=function(){return h},this.getSession=function(){return r},this.setSession=async function(u){if(r=u,r!==null){if(x=e.getRenderTarget(),r.addEventListener(`select`,M),r.addEventListener(`selectstart`,M),r.addEventListener(`selectend`,M),r.addEventListener(`squeeze`,M),r.addEventListener(`squeezestart`,M),r.addEventListener(`squeezeend`,M),r.addEventListener(`end`,ie),r.addEventListener(`inputsourceschange`,ae),b.xrCompatible!==!0&&await t.makeXRCompatible(),O=e.getPixelRatio(),e.getSize(ee),g&&`createProjectionLayer`in XRWebGLBinding.prototype){let n=null,a=null,o=null;b.depth&&(o=b.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,n=b.stencil?E:T,a=b.stencil?y:m);let s={colorFormat:t.RGBA8,depthFormat:o,scaleFactor:i};d=this.getBinding(),f=d.createProjectionLayer(s),r.updateRenderState({layers:[f]}),e.setPixelRatio(1),e.setSize(f.textureWidth,f.textureHeight,!1),S=new Gt(f.textureWidth,f.textureHeight,{format:w,type:l,depthTexture:new gi(f.textureWidth,f.textureHeight,a,void 0,void 0,void 0,void 0,void 0,void 0,n),stencilBuffer:b.stencil,colorSpace:e.outputColorSpace,samples:b.antialias?4:0,resolveDepthBuffer:f.ignoreDepthValues===!1,resolveStencilBuffer:f.ignoreDepthValues===!1})}else{let n={antialias:b.antialias,alpha:!0,depth:b.depth,stencil:b.stencil,framebufferScaleFactor:i};p=new XRWebGLLayer(r,t,n),r.updateRenderState({baseLayer:p}),e.setPixelRatio(1),e.setSize(p.framebufferWidth,p.framebufferHeight,!1),S=new Gt(p.framebufferWidth,p.framebufferHeight,{format:w,type:l,colorSpace:e.outputColorSpace,stencilBuffer:b.stencil,resolveDepthBuffer:p.ignoreDepthValues===!1,resolveStencilBuffer:p.ignoreDepthValues===!1})}S.isXRRenderTarget=!0,this.setFoveation(s),c=null,a=await r.requestReferenceSpace(o),de.setContext(r),de.start(),n.isPresenting=!0,n.dispatchEvent({type:`sessionstart`})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return _.getDepthTexture()};function ae(e){for(let t=0;t<e.removed.length;t++){let n=e.removed[t],r=D.indexOf(n);r>=0&&(D[r]=null,C[r].disconnect(n))}for(let t=0;t<e.added.length;t++){let n=e.added[t],r=D.indexOf(n);if(r===-1){for(let e=0;e<C.length;e++)if(e>=D.length){D.push(n),r=e;break}else if(D[e]===null){D[e]=n,r=e;break}if(r===-1)break}let i=C[r];i&&i.connect(n)}}let oe=new G,se=new G;function N(e,t,n){oe.setFromMatrixPosition(t.matrixWorld),se.setFromMatrixPosition(n.matrixWorld);let r=oe.distanceTo(se),i=t.projectionMatrix.elements,a=n.projectionMatrix.elements,o=i[14]/(i[10]-1),s=i[14]/(i[10]+1),c=(i[9]+1)/i[5],l=(i[9]-1)/i[5],u=(i[8]-1)/i[0],d=(a[8]+1)/a[0],f=o*u,p=o*d,m=r/(-u+d),h=m*-u;if(t.matrixWorld.decompose(e.position,e.quaternion,e.scale),e.translateX(h),e.translateZ(m),e.matrixWorld.compose(e.position,e.quaternion,e.scale),e.matrixWorldInverse.copy(e.matrixWorld).invert(),i[10]===-1)e.projectionMatrix.copy(t.projectionMatrix),e.projectionMatrixInverse.copy(t.projectionMatrixInverse);else{let t=o+m,n=s+m,i=f-h,a=p+(r-h),u=c*s/n*t,d=l*s/n*t;e.projectionMatrix.makePerspective(i,a,u,d,t,n),e.projectionMatrixInverse.copy(e.projectionMatrix).invert()}}function ce(e,t){t===null?e.matrixWorld.copy(e.matrix):e.matrixWorld.multiplyMatrices(t.matrixWorld,e.matrix),e.matrixWorldInverse.copy(e.matrixWorld).invert()}this.updateCamera=function(e){if(r===null)return;let t=e.near,n=e.far;_.texture!==null&&(_.depthNear>0&&(t=_.depthNear),_.depthFar>0&&(n=_.depthFar)),j.near=te.near=k.near=t,j.far=te.far=k.far=n,(ne!==j.near||re!==j.far)&&(r.updateRenderState({depthNear:j.near,depthFar:j.far}),ne=j.near,re=j.far),j.layers.mask=e.layers.mask|6,k.layers.mask=j.layers.mask&-5,te.layers.mask=j.layers.mask&-3;let i=e.parent,a=j.cameras;ce(j,i);for(let e=0;e<a.length;e++)ce(a[e],i);a.length===2?N(j,k,te):j.projectionMatrix.copy(k.projectionMatrix),le(e,j,i)};function le(e,t,n){n===null?e.matrix.copy(t.matrixWorld):(e.matrix.copy(n.matrixWorld),e.matrix.invert(),e.matrix.multiply(t.matrixWorld)),e.matrix.decompose(e.position,e.quaternion,e.scale),e.updateMatrixWorld(!0),e.projectionMatrix.copy(t.projectionMatrix),e.projectionMatrixInverse.copy(t.projectionMatrixInverse),e.isPerspectiveCamera&&(e.fov=rt*2*Math.atan(1/e.projectionMatrix.elements[5]),e.zoom=1)}this.getCamera=function(){return j},this.getFoveation=function(){if(!(f===null&&p===null))return s},this.setFoveation=function(e){s=e,f!==null&&(f.fixedFoveation=e),p!==null&&p.fixedFoveation!==void 0&&(p.fixedFoveation=e)},this.hasDepthSensing=function(){return _.texture!==null},this.getDepthSensingMesh=function(){return _.getMesh(j)},this.getCameraTexture=function(e){return v[e]};let P=null;function ue(t,i){if(u=i.getViewerPose(c||a),h=i,u!==null){let t=u.views;p!==null&&(e.setRenderTargetFramebuffer(S,p.framebuffer),e.setRenderTarget(S));let i=!1;t.length!==j.cameras.length&&(j.cameras.length=0,i=!0);for(let n=0;n<t.length;n++){let r=t[n],a=null;if(p!==null)a=p.getViewport(r);else{let t=d.getViewSubImage(f,r);a=t.viewport,n===0&&(e.setRenderTargetTextures(S,t.colorTexture,t.depthStencilTexture),e.setRenderTarget(S))}let o=A[n];o===void 0&&(o=new Va,o.layers.enable(n),o.viewport=new Ut,A[n]=o),o.matrix.fromArray(r.transform.matrix),o.matrix.decompose(o.position,o.quaternion,o.scale),o.projectionMatrix.fromArray(r.projectionMatrix),o.projectionMatrixInverse.copy(o.projectionMatrix).invert(),o.viewport.set(a.x,a.y,a.width,a.height),n===0&&(j.matrix.copy(o.matrix),j.matrix.decompose(j.position,j.quaternion,j.scale)),i===!0&&j.cameras.push(o)}let a=r.enabledFeatures;if(a&&a.includes(`depth-sensing`)&&r.depthUsage==`gpu-optimized`&&g){d=n.getBinding();let e=d.getDepthInformation(t[0]);e&&e.isValid&&e.texture&&_.init(e,r.renderState)}if(a&&a.includes(`camera-access`)&&g){e.state.unbindTexture(),d=n.getBinding();for(let e=0;e<t.length;e++){let n=t[e].camera;if(n){let e=v[n];e||(e=new vi,v[n]=e);let t=d.getCameraImage(n);e.sourceTexture=t}}}}for(let e=0;e<C.length;e++){let t=D[e],n=C[e];t!==null&&n!==void 0&&n.update(t,i,c||a)}P&&P(t,i),i.detectedPlanes&&n.dispatchEvent({type:`planesdetected`,data:i}),h=null}let de=new fo;de.setAnimationLoop(ue),this.setAnimationLoop=function(e){P=e},this.dispose=function(){}}},bl=new Jt,xl=new K;xl.set(-1,0,0,0,1,0,0,0,1);function Sl(e,t){function n(e,t){e.matrixAutoUpdate===!0&&e.updateMatrix(),t.value.copy(e.matrix)}function r(t,n){n.color.getRGB(t.fogColor.value,ra(e)),n.isFog?(t.fogNear.value=n.near,t.fogFar.value=n.far):n.isFogExp2&&(t.fogDensity.value=n.density)}function i(e,t,n,r,i){t.isNodeMaterial?t.uniformsNeedUpdate=!1:t.isMeshBasicMaterial?a(e,t):t.isMeshLambertMaterial?(a(e,t),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)):t.isMeshToonMaterial?(a(e,t),d(e,t)):t.isMeshPhongMaterial?(a(e,t),u(e,t),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)):t.isMeshStandardMaterial?(a(e,t),f(e,t),t.isMeshPhysicalMaterial&&p(e,t,i)):t.isMeshMatcapMaterial?(a(e,t),m(e,t)):t.isMeshDepthMaterial?a(e,t):t.isMeshDistanceMaterial?(a(e,t),h(e,t)):t.isMeshNormalMaterial?a(e,t):t.isLineBasicMaterial?(o(e,t),t.isLineDashedMaterial&&s(e,t)):t.isPointsMaterial?c(e,t,n,r):t.isSpriteMaterial?l(e,t):t.isShadowMaterial?(e.color.value.copy(t.color),e.opacity.value=t.opacity):t.isShaderMaterial&&(t.uniformsNeedUpdate=!1)}function a(e,r){e.opacity.value=r.opacity,r.color&&e.diffuse.value.copy(r.color),r.emissive&&e.emissive.value.copy(r.emissive).multiplyScalar(r.emissiveIntensity),r.map&&(e.map.value=r.map,n(r.map,e.mapTransform)),r.alphaMap&&(e.alphaMap.value=r.alphaMap,n(r.alphaMap,e.alphaMapTransform)),r.bumpMap&&(e.bumpMap.value=r.bumpMap,n(r.bumpMap,e.bumpMapTransform),e.bumpScale.value=r.bumpScale,r.side===1&&(e.bumpScale.value*=-1)),r.normalMap&&(e.normalMap.value=r.normalMap,n(r.normalMap,e.normalMapTransform),e.normalScale.value.copy(r.normalScale),r.side===1&&e.normalScale.value.negate()),r.displacementMap&&(e.displacementMap.value=r.displacementMap,n(r.displacementMap,e.displacementMapTransform),e.displacementScale.value=r.displacementScale,e.displacementBias.value=r.displacementBias),r.emissiveMap&&(e.emissiveMap.value=r.emissiveMap,n(r.emissiveMap,e.emissiveMapTransform)),r.specularMap&&(e.specularMap.value=r.specularMap,n(r.specularMap,e.specularMapTransform)),r.alphaTest>0&&(e.alphaTest.value=r.alphaTest);let i=t.get(r),a=i.envMap,o=i.envMapRotation;a&&(e.envMap.value=a,e.envMapRotation.value.setFromMatrix4(bl.makeRotationFromEuler(o)).transpose(),a.isCubeTexture&&a.isRenderTargetTexture===!1&&e.envMapRotation.value.premultiply(xl),e.reflectivity.value=r.reflectivity,e.ior.value=r.ior,e.refractionRatio.value=r.refractionRatio),r.lightMap&&(e.lightMap.value=r.lightMap,e.lightMapIntensity.value=r.lightMapIntensity,n(r.lightMap,e.lightMapTransform)),r.aoMap&&(e.aoMap.value=r.aoMap,e.aoMapIntensity.value=r.aoMapIntensity,n(r.aoMap,e.aoMapTransform))}function o(e,t){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,t.map&&(e.map.value=t.map,n(t.map,e.mapTransform))}function s(e,t){e.dashSize.value=t.dashSize,e.totalSize.value=t.dashSize+t.gapSize,e.scale.value=t.scale}function c(e,t,r,i){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,e.size.value=t.size*r,e.scale.value=i*.5,t.map&&(e.map.value=t.map,n(t.map,e.uvTransform)),t.alphaMap&&(e.alphaMap.value=t.alphaMap,n(t.alphaMap,e.alphaMapTransform)),t.alphaTest>0&&(e.alphaTest.value=t.alphaTest)}function l(e,t){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,e.rotation.value=t.rotation,t.map&&(e.map.value=t.map,n(t.map,e.mapTransform)),t.alphaMap&&(e.alphaMap.value=t.alphaMap,n(t.alphaMap,e.alphaMapTransform)),t.alphaTest>0&&(e.alphaTest.value=t.alphaTest)}function u(e,t){e.specular.value.copy(t.specular),e.shininess.value=Math.max(t.shininess,1e-4)}function d(e,t){t.gradientMap&&(e.gradientMap.value=t.gradientMap)}function f(e,t){e.metalness.value=t.metalness,t.metalnessMap&&(e.metalnessMap.value=t.metalnessMap,n(t.metalnessMap,e.metalnessMapTransform)),e.roughness.value=t.roughness,t.roughnessMap&&(e.roughnessMap.value=t.roughnessMap,n(t.roughnessMap,e.roughnessMapTransform)),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)}function p(e,t,r){e.ior.value=t.ior,t.sheen>0&&(e.sheenColor.value.copy(t.sheenColor).multiplyScalar(t.sheen),e.sheenRoughness.value=t.sheenRoughness,t.sheenColorMap&&(e.sheenColorMap.value=t.sheenColorMap,n(t.sheenColorMap,e.sheenColorMapTransform)),t.sheenRoughnessMap&&(e.sheenRoughnessMap.value=t.sheenRoughnessMap,n(t.sheenRoughnessMap,e.sheenRoughnessMapTransform))),t.clearcoat>0&&(e.clearcoat.value=t.clearcoat,e.clearcoatRoughness.value=t.clearcoatRoughness,t.clearcoatMap&&(e.clearcoatMap.value=t.clearcoatMap,n(t.clearcoatMap,e.clearcoatMapTransform)),t.clearcoatRoughnessMap&&(e.clearcoatRoughnessMap.value=t.clearcoatRoughnessMap,n(t.clearcoatRoughnessMap,e.clearcoatRoughnessMapTransform)),t.clearcoatNormalMap&&(e.clearcoatNormalMap.value=t.clearcoatNormalMap,n(t.clearcoatNormalMap,e.clearcoatNormalMapTransform),e.clearcoatNormalScale.value.copy(t.clearcoatNormalScale),t.side===1&&e.clearcoatNormalScale.value.negate())),t.dispersion>0&&(e.dispersion.value=t.dispersion),t.iridescence>0&&(e.iridescence.value=t.iridescence,e.iridescenceIOR.value=t.iridescenceIOR,e.iridescenceThicknessMinimum.value=t.iridescenceThicknessRange[0],e.iridescenceThicknessMaximum.value=t.iridescenceThicknessRange[1],t.iridescenceMap&&(e.iridescenceMap.value=t.iridescenceMap,n(t.iridescenceMap,e.iridescenceMapTransform)),t.iridescenceThicknessMap&&(e.iridescenceThicknessMap.value=t.iridescenceThicknessMap,n(t.iridescenceThicknessMap,e.iridescenceThicknessMapTransform))),t.transmission>0&&(e.transmission.value=t.transmission,e.transmissionSamplerMap.value=r.texture,e.transmissionSamplerSize.value.set(r.width,r.height),t.transmissionMap&&(e.transmissionMap.value=t.transmissionMap,n(t.transmissionMap,e.transmissionMapTransform)),e.thickness.value=t.thickness,t.thicknessMap&&(e.thicknessMap.value=t.thicknessMap,n(t.thicknessMap,e.thicknessMapTransform)),e.attenuationDistance.value=t.attenuationDistance,e.attenuationColor.value.copy(t.attenuationColor)),t.anisotropy>0&&(e.anisotropyVector.value.set(t.anisotropy*Math.cos(t.anisotropyRotation),t.anisotropy*Math.sin(t.anisotropyRotation)),t.anisotropyMap&&(e.anisotropyMap.value=t.anisotropyMap,n(t.anisotropyMap,e.anisotropyMapTransform))),e.specularIntensity.value=t.specularIntensity,e.specularColor.value.copy(t.specularColor),t.specularColorMap&&(e.specularColorMap.value=t.specularColorMap,n(t.specularColorMap,e.specularColorMapTransform)),t.specularIntensityMap&&(e.specularIntensityMap.value=t.specularIntensityMap,n(t.specularIntensityMap,e.specularIntensityMapTransform))}function m(e,t){t.matcap&&(e.matcap.value=t.matcap)}function h(e,n){let r=t.get(n).light;e.referencePosition.value.setFromMatrixPosition(r.matrixWorld),e.nearDistance.value=r.shadow.camera.near,e.farDistance.value=r.shadow.camera.far}return{refreshFogUniforms:r,refreshMaterialUniforms:i}}function Cl(e,t,n,r){let i={},a={},o=[],s=e.getParameter(e.MAX_UNIFORM_BUFFER_BINDINGS);function c(e,t){let n=t.program;r.uniformBlockBinding(e,n)}function l(e,n){let o=i[e.id];o===void 0&&(m(e),o=u(e),i[e.id]=o,e.addEventListener(`dispose`,g));let s=n.program;r.updateUBOMapping(e,s);let c=t.render.frame;a[e.id]!==c&&(f(e),a[e.id]=c)}function u(t){let n=d();t.__bindingPointIndex=n;let r=e.createBuffer(),i=t.__size,a=t.usage;return e.bindBuffer(e.UNIFORM_BUFFER,r),e.bufferData(e.UNIFORM_BUFFER,i,a),e.bindBuffer(e.UNIFORM_BUFFER,null),e.bindBufferBase(e.UNIFORM_BUFFER,n,r),r}function d(){for(let e=0;e<s;e++)if(o.indexOf(e)===-1)return o.push(e),e;return H(`WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached.`),0}function f(t){let n=i[t.id],r=t.uniforms,a=t.__cache;e.bindBuffer(e.UNIFORM_BUFFER,n);for(let t=0,n=r.length;t<n;t++){let n=Array.isArray(r[t])?r[t]:[r[t]];for(let r=0,i=n.length;r<i;r++){let i=n[r];if(p(i,t,r,a)===!0){let t=i.__offset,n=Array.isArray(i.value)?i.value:[i.value],r=0;for(let a=0;a<n.length;a++){let o=n[a],s=h(o);typeof o==`number`||typeof o==`boolean`?(i.__data[0]=o,e.bufferSubData(e.UNIFORM_BUFFER,t+r,i.__data)):o.isMatrix3?(i.__data[0]=o.elements[0],i.__data[1]=o.elements[1],i.__data[2]=o.elements[2],i.__data[3]=0,i.__data[4]=o.elements[3],i.__data[5]=o.elements[4],i.__data[6]=o.elements[5],i.__data[7]=0,i.__data[8]=o.elements[6],i.__data[9]=o.elements[7],i.__data[10]=o.elements[8],i.__data[11]=0):ArrayBuffer.isView(o)?i.__data.set(new o.constructor(o.buffer,o.byteOffset,i.__data.length)):(o.toArray(i.__data,r),r+=s.storage/Float32Array.BYTES_PER_ELEMENT)}e.bufferSubData(e.UNIFORM_BUFFER,t,i.__data)}}}e.bindBuffer(e.UNIFORM_BUFFER,null)}function p(e,t,n,r){let i=e.value,a=t+`_`+n;if(r[a]===void 0)return typeof i==`number`||typeof i==`boolean`?r[a]=i:ArrayBuffer.isView(i)?r[a]=i.slice():r[a]=i.clone(),!0;{let e=r[a];if(typeof i==`number`||typeof i==`boolean`){if(e!==i)return r[a]=i,!0}else if(ArrayBuffer.isView(i))return!0;else if(e.equals(i)===!1)return e.copy(i),!0}return!1}function m(e){let t=e.uniforms,n=0;for(let e=0,r=t.length;e<r;e++){let r=Array.isArray(t[e])?t[e]:[t[e]];for(let e=0,t=r.length;e<t;e++){let t=r[e],i=Array.isArray(t.value)?t.value:[t.value];for(let e=0,r=i.length;e<r;e++){let r=i[e],a=h(r),o=n%16,s=o%a.boundary,c=o+s;n+=s,c!==0&&16-c<a.storage&&(n+=16-c),t.__data=new Float32Array(a.storage/Float32Array.BYTES_PER_ELEMENT),t.__offset=n,n+=a.storage}}}let r=n%16;return r>0&&(n+=16-r),e.__size=n,e.__cache={},this}function h(e){let t={boundary:0,storage:0};return typeof e==`number`||typeof e==`boolean`?(t.boundary=4,t.storage=4):e.isVector2?(t.boundary=8,t.storage=8):e.isVector3||e.isColor?(t.boundary=16,t.storage=12):e.isVector4?(t.boundary=16,t.storage=16):e.isMatrix3?(t.boundary=48,t.storage=48):e.isMatrix4?(t.boundary=64,t.storage=64):e.isTexture?V(`WebGLRenderer: Texture samplers can not be part of an uniforms group.`):ArrayBuffer.isView(e)?(t.boundary=16,t.storage=e.byteLength):V(`WebGLRenderer: Unsupported uniform value type.`,e),t}function g(t){let n=t.target;n.removeEventListener(`dispose`,g);let r=o.indexOf(n.__bindingPointIndex);o.splice(r,1),e.deleteBuffer(i[n.id]),delete i[n.id],delete a[n.id]}function _(){for(let t in i)e.deleteBuffer(i[t]);o=[],i={},a={}}return{bind:c,update:l,dispose:_}}var wl=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]),Tl=null;function El(){return Tl===null&&(Tl=new Zr(wl,16,16,O,g),Tl.name=`DFG_LUT`,Tl.minFilter=o,Tl.magFilter=o,Tl.wrapS=t,Tl.wrapT=t,Tl.generateMipmaps=!1,Tl.needsUpdate=!0),Tl}var Dl=class{constructor(e={}){let{canvas:t=Ge(),context:n=null,depth:r=!0,stencil:i=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:s=!0,preserveDrawingBuffer:u=!1,powerPreference:d=`default`,failIfMajorPerformanceCaveat:p=!1,reversedDepthBuffer:h=!1,outputBufferType:b=l}=e;this.isWebGLRenderer=!0;let x;if(n!==null){if(typeof WebGLRenderingContext<`u`&&n instanceof WebGLRenderingContext)throw Error(`THREE.WebGLRenderer: WebGL 1 is not supported since r163.`);x=n.getContextAttributes().alpha}else x=a;let S=b,C=new Set([te,k,ee]),w=new Set([l,m,f,y,_,v]),T=new Uint32Array(4),E=new Int32Array(4),D=new G,O=null,A=null,j=[],ne=[],re=null;this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=0,this.toneMappingExposure=1,this.transmissionResolutionScale=1;let M=this,ie=!1,ae=null;this._outputColorSpace=Fe;let oe=0,se=0,N=null,ce=-1,le=null,P=new Ut,ue=new Ut,de=null,fe=new J(0),pe=0,me=t.width,he=t.height,F=1,ge=null,_e=null,ve=new Ut(0,0,me,he),ye=new Ut(0,0,me,he),be=!1,xe=new mi,Se=!1,Ce=!1,we=new Jt,Te=new G,Ee=new Ut,De={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0},Oe=!1;function ke(){return N===null?F:1}let I=n;function Ae(e,n){return t.getContext(e,n)}try{let e={alpha:!0,depth:r,stencil:i,antialias:o,premultipliedAlpha:s,preserveDrawingBuffer:u,powerPreference:d,failIfMajorPerformanceCaveat:p};if(`setAttribute`in t&&t.setAttribute(`data-engine`,`three.js r184`),t.addEventListener(`webglcontextlost`,rt,!1),t.addEventListener(`webglcontextrestored`,it,!1),t.addEventListener(`webglcontextcreationerror`,U,!1),I===null){let t=`webgl2`;if(I=Ae(t,e),I===null)throw Ae(t)?Error(`Error creating WebGL context with your selected attributes.`):Error(`Error creating WebGL context.`)}}catch(e){throw H(`WebGLRenderer: `+e.message),e}let L,je,R,Me,z,B,Ne,Pe,Ie,Le,Re,ze,Be,He,Ue,We,Ke,qe,Ye,Xe,Qe,$e,et;function tt(){L=new Go(I),L.init(),Qe=new hl(I,L),je=new xo(I,L,e,Qe),R=new pl(I,L),je.reversedDepthBuffer&&h&&R.buffers.depth.setReversed(!0),Me=new Jo(I),z=new qc,B=new ml(I,L,R,z,je,Qe,Me),Ne=new Wo(M),Pe=new po(I),$e=new yo(I,Pe),Ie=new Ko(I,Pe,Me,$e),Le=new Xo(I,Ie,Pe,$e,Me),qe=new Yo(I,je,B),Ue=new So(z),Re=new Kc(M,Ne,L,je,$e,Ue),ze=new Sl(M,z),Be=new Zc,He=new il(L),Ke=new vo(M,Ne,R,Le,x,s),We=new fl(M,Le,je),et=new Cl(I,Me,je,R),Ye=new bo(I,L,Me),Xe=new qo(I,L,Me),Me.programs=Re.programs,M.capabilities=je,M.extensions=L,M.properties=z,M.renderLists=Be,M.shadowMap=We,M.state=R,M.info=Me}tt(),S!==1009&&(re=new Qo(S,t.width,t.height,r,i));let nt=new yl(M,I);this.xr=nt,this.getContext=function(){return I},this.getContextAttributes=function(){return I.getContextAttributes()},this.forceContextLoss=function(){let e=L.get(`WEBGL_lose_context`);e&&e.loseContext()},this.forceContextRestore=function(){let e=L.get(`WEBGL_lose_context`);e&&e.restoreContext()},this.getPixelRatio=function(){return F},this.setPixelRatio=function(e){e!==void 0&&(F=e,this.setSize(me,he,!1))},this.getSize=function(e){return e.set(me,he)},this.setSize=function(e,n,r=!0){if(nt.isPresenting){V(`WebGLRenderer: Can't change size while VR device is presenting.`);return}me=e,he=n,t.width=Math.floor(e*F),t.height=Math.floor(n*F),r===!0&&(t.style.width=e+`px`,t.style.height=n+`px`),re!==null&&re.setSize(t.width,t.height),this.setViewport(0,0,e,n)},this.getDrawingBufferSize=function(e){return e.set(me*F,he*F).floor()},this.setDrawingBufferSize=function(e,n,r){me=e,he=n,F=r,t.width=Math.floor(e*r),t.height=Math.floor(n*r),this.setViewport(0,0,e,n)},this.setEffects=function(e){if(S===1009){H(`THREE.WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.`);return}if(e){for(let t=0;t<e.length;t++)if(e[t].isOutputPass===!0){V(`THREE.WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.`);break}}re.setEffects(e||[])},this.getCurrentViewport=function(e){return e.copy(P)},this.getViewport=function(e){return e.copy(ve)},this.setViewport=function(e,t,n,r){e.isVector4?ve.set(e.x,e.y,e.z,e.w):ve.set(e,t,n,r),R.viewport(P.copy(ve).multiplyScalar(F).round())},this.getScissor=function(e){return e.copy(ye)},this.setScissor=function(e,t,n,r){e.isVector4?ye.set(e.x,e.y,e.z,e.w):ye.set(e,t,n,r),R.scissor(ue.copy(ye).multiplyScalar(F).round())},this.getScissorTest=function(){return be},this.setScissorTest=function(e){R.setScissorTest(be=e)},this.setOpaqueSort=function(e){ge=e},this.setTransparentSort=function(e){_e=e},this.getClearColor=function(e){return e.copy(Ke.getClearColor())},this.setClearColor=function(){Ke.setClearColor(...arguments)},this.getClearAlpha=function(){return Ke.getClearAlpha()},this.setClearAlpha=function(){Ke.setClearAlpha(...arguments)},this.clear=function(e=!0,t=!0,n=!0){let r=0;if(e){let e=!1;if(N!==null){let t=N.texture.format;e=C.has(t)}if(e){let e=N.texture.type,t=w.has(e),n=Ke.getClearColor(),r=Ke.getClearAlpha(),i=n.r,a=n.g,o=n.b;t?(T[0]=i,T[1]=a,T[2]=o,T[3]=r,I.clearBufferuiv(I.COLOR,0,T)):(E[0]=i,E[1]=a,E[2]=o,E[3]=r,I.clearBufferiv(I.COLOR,0,E))}else r|=I.COLOR_BUFFER_BIT}t&&(r|=I.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),n&&(r|=I.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),r!==0&&I.clear(r)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(e){e.setRenderer(this),ae=e},this.dispose=function(){t.removeEventListener(`webglcontextlost`,rt,!1),t.removeEventListener(`webglcontextrestored`,it,!1),t.removeEventListener(`webglcontextcreationerror`,U,!1),Ke.dispose(),Be.dispose(),He.dispose(),z.dispose(),Ne.dispose(),Le.dispose(),$e.dispose(),et.dispose(),Re.dispose(),nt.dispose(),nt.removeEventListener(`sessionstart`,dt),nt.removeEventListener(`sessionend`,ft),pt.stop()};function rt(e){e.preventDefault(),Je(`WebGLRenderer: Context Lost.`),ie=!0}function it(){Je(`WebGLRenderer: Context Restored.`),ie=!1;let e=Me.autoReset,t=We.enabled,n=We.autoUpdate,r=We.needsUpdate,i=We.type;tt(),Me.autoReset=e,We.enabled=t,We.autoUpdate=n,We.needsUpdate=r,We.type=i}function U(e){H(`WebGLRenderer: A WebGL context could not be created. Reason: `,e.statusMessage)}function at(e){let t=e.target;t.removeEventListener(`dispose`,at),ot(t)}function ot(e){st(e),z.remove(e)}function st(e){let t=z.get(e).programs;t!==void 0&&(t.forEach(function(e){Re.releaseProgram(e)}),e.isShaderMaterial&&Re.releaseShaderCache(e))}this.renderBufferDirect=function(e,t,n,r,i,a){t===null&&(t=De);let o=i.isMesh&&i.matrixWorld.determinant()<0,s=Ct(e,t,n,r,i);R.setMaterial(r,o);let c=n.index,l=1;if(r.wireframe===!0){if(c=Ie.getWireframeAttribute(n),c===void 0)return;l=2}let u=n.drawRange,d=n.attributes.position,f=u.start*l,p=(u.start+u.count)*l;a!==null&&(f=Math.max(f,a.start*l),p=Math.min(p,(a.start+a.count)*l)),c===null?d!=null&&(f=Math.max(f,0),p=Math.min(p,d.count)):(f=Math.max(f,0),p=Math.min(p,c.count));let m=p-f;if(m<0||m===1/0)return;$e.setup(i,r,s,n,c);let h,g=Ye;if(c!==null&&(h=Pe.get(c),g=Xe,g.setIndex(h)),i.isMesh)r.wireframe===!0?(R.setLineWidth(r.wireframeLinewidth*ke()),g.setMode(I.LINES)):g.setMode(I.TRIANGLES);else if(i.isLine){let e=r.linewidth;e===void 0&&(e=1),R.setLineWidth(e*ke()),i.isLineSegments?g.setMode(I.LINES):i.isLineLoop?g.setMode(I.LINE_LOOP):g.setMode(I.LINE_STRIP)}else i.isPoints?g.setMode(I.POINTS):i.isSprite&&g.setMode(I.TRIANGLES);if(i.isBatchedMesh)if(L.get(`WEBGL_multi_draw`))g.renderMultiDraw(i._multiDrawStarts,i._multiDrawCounts,i._multiDrawCount);else{let e=i._multiDrawStarts,t=i._multiDrawCounts,n=i._multiDrawCount,a=c?Pe.get(c).bytesPerElement:1,o=z.get(r).currentProgram.getUniforms();for(let r=0;r<n;r++)o.setValue(I,`_gl_DrawID`,r),g.render(e[r]/a,t[r])}else if(i.isInstancedMesh)g.renderInstances(f,m,i.count);else if(n.isInstancedBufferGeometry){let e=n._maxInstanceCount===void 0?1/0:n._maxInstanceCount,t=Math.min(n.instanceCount,e);g.renderInstances(f,m,t)}else g.render(f,m)};function ct(e,t,n){e.transparent===!0&&e.side===2&&e.forceSinglePass===!1?(e.side=1,e.needsUpdate=!0,yt(e,t,n),e.side=0,e.needsUpdate=!0,yt(e,t,n),e.side=2):yt(e,t,n)}this.compile=function(e,t,n=null){n===null&&(n=e),A=He.get(n),A.init(t),ne.push(A),n.traverseVisible(function(e){e.isLight&&e.layers.test(t.layers)&&(A.pushLight(e),e.castShadow&&A.pushShadow(e))}),e!==n&&e.traverseVisible(function(e){e.isLight&&e.layers.test(t.layers)&&(A.pushLight(e),e.castShadow&&A.pushShadow(e))}),A.setupLights();let r=new Set;return e.traverse(function(e){if(!(e.isMesh||e.isPoints||e.isLine||e.isSprite))return;let t=e.material;if(t)if(Array.isArray(t))for(let i=0;i<t.length;i++){let a=t[i];ct(a,n,e),r.add(a)}else ct(t,n,e),r.add(t)}),A=ne.pop(),r},this.compileAsync=function(e,t,n=null){let r=this.compile(e,t,n);return new Promise(t=>{function n(){if(r.forEach(function(e){z.get(e).currentProgram.isReady()&&r.delete(e)}),r.size===0){t(e);return}setTimeout(n,10)}L.get(`KHR_parallel_shader_compile`)===null?setTimeout(n,10):n()})};let lt=null;function ut(e){lt&&lt(e)}function dt(){pt.stop()}function ft(){pt.start()}let pt=new fo;pt.setAnimationLoop(ut),typeof self<`u`&&pt.setContext(self),this.setAnimationLoop=function(e){lt=e,nt.setAnimationLoop(e),e===null?pt.stop():pt.start()},nt.addEventListener(`sessionstart`,dt),nt.addEventListener(`sessionend`,ft),this.render=function(e,t){if(t!==void 0&&t.isCamera!==!0){H(`WebGLRenderer.render: camera is not an instance of THREE.Camera.`);return}if(ie===!0)return;ae!==null&&ae.renderStart(e,t);let n=nt.enabled===!0&&nt.isPresenting===!0,r=re!==null&&(N===null||n)&&re.begin(M,N);if(e.matrixWorldAutoUpdate===!0&&e.updateMatrixWorld(),t.parent===null&&t.matrixWorldAutoUpdate===!0&&t.updateMatrixWorld(),nt.enabled===!0&&nt.isPresenting===!0&&(re===null||re.isCompositing()===!1)&&(nt.cameraAutoUpdate===!0&&nt.updateCamera(t),t=nt.getCamera()),e.isScene===!0&&e.onBeforeRender(M,e,t,N),A=He.get(e,ne.length),A.init(t),A.state.textureUnits=B.getTextureUnits(),ne.push(A),we.multiplyMatrices(t.projectionMatrix,t.matrixWorldInverse),xe.setFromProjectionMatrix(we,Ve,t.reversedDepth),Ce=this.localClippingEnabled,Se=Ue.init(this.clippingPlanes,Ce),O=Be.get(e,j.length),O.init(),j.push(O),nt.enabled===!0&&nt.isPresenting===!0){let e=M.xr.getDepthSensingMesh();e!==null&&mt(e,t,-1/0,M.sortObjects)}mt(e,t,0,M.sortObjects),O.finish(),M.sortObjects===!0&&O.sort(ge,_e),Oe=nt.enabled===!1||nt.isPresenting===!1||nt.hasDepthSensing()===!1,Oe&&Ke.addToRenderList(O,e),this.info.render.frame++,Se===!0&&Ue.beginShadows();let i=A.state.shadowsArray;if(We.render(i,e,t),Se===!0&&Ue.endShadows(),this.info.autoReset===!0&&this.info.reset(),(r&&re.hasRenderPass())===!1){let n=O.opaque,r=O.transmissive;if(A.setupLights(),t.isArrayCamera){let i=t.cameras;if(r.length>0)for(let t=0,a=i.length;t<a;t++){let a=i[t];gt(n,r,e,a)}Oe&&Ke.render(e);for(let t=0,n=i.length;t<n;t++){let n=i[t];ht(O,e,n,n.viewport)}}else r.length>0&&gt(n,r,e,t),Oe&&Ke.render(e),ht(O,e,t)}N!==null&&se===0&&(B.updateMultisampleRenderTarget(N),B.updateRenderTargetMipmap(N)),r&&re.end(M),e.isScene===!0&&e.onAfterRender(M,e,t),$e.resetDefaultState(),ce=-1,le=null,ne.pop(),ne.length>0?(A=ne[ne.length-1],B.setTextureUnits(A.state.textureUnits),Se===!0&&Ue.setGlobalState(M.clippingPlanes,A.state.camera)):A=null,j.pop(),O=j.length>0?j[j.length-1]:null,ae!==null&&ae.renderEnd()};function mt(e,t,n,r){if(e.visible===!1)return;if(e.layers.test(t.layers)){if(e.isGroup)n=e.renderOrder;else if(e.isLOD)e.autoUpdate===!0&&e.update(t);else if(e.isLightProbeGrid)A.pushLightProbeGrid(e);else if(e.isLight)A.pushLight(e),e.castShadow&&A.pushShadow(e);else if(e.isSprite){if(!e.frustumCulled||xe.intersectsSprite(e)){r&&Ee.setFromMatrixPosition(e.matrixWorld).applyMatrix4(we);let t=Le.update(e),i=e.material;i.visible&&O.push(e,t,i,n,Ee.z,null)}}else if((e.isMesh||e.isLine||e.isPoints)&&(!e.frustumCulled||xe.intersectsObject(e))){let t=Le.update(e),i=e.material;if(r&&(e.boundingSphere===void 0?(t.boundingSphere===null&&t.computeBoundingSphere(),Ee.copy(t.boundingSphere.center)):(e.boundingSphere===null&&e.computeBoundingSphere(),Ee.copy(e.boundingSphere.center)),Ee.applyMatrix4(e.matrixWorld).applyMatrix4(we)),Array.isArray(i)){let r=t.groups;for(let a=0,o=r.length;a<o;a++){let o=r[a],s=i[o.materialIndex];s&&s.visible&&O.push(e,t,s,n,Ee.z,o)}}else i.visible&&O.push(e,t,i,n,Ee.z,null)}}let i=e.children;for(let e=0,a=i.length;e<a;e++)mt(i[e],t,n,r)}function ht(e,t,n,r){let{opaque:i,transmissive:a,transparent:o}=e;A.setupLightsView(n),Se===!0&&Ue.setGlobalState(M.clippingPlanes,n),r&&R.viewport(P.copy(r)),i.length>0&&_t(i,t,n),a.length>0&&_t(a,t,n),o.length>0&&_t(o,t,n),R.buffers.depth.setTest(!0),R.buffers.depth.setMask(!0),R.buffers.color.setMask(!0),R.setPolygonOffset(!1)}function gt(e,t,n,r){if((n.isScene===!0?n.overrideMaterial:null)!==null)return;if(A.state.transmissionRenderTarget[r.id]===void 0){let e=L.has(`EXT_color_buffer_half_float`)||L.has(`EXT_color_buffer_float`);A.state.transmissionRenderTarget[r.id]=new Gt(1,1,{generateMipmaps:!0,type:e?g:l,minFilter:c,samples:Math.max(4,je.samples),stencilBuffer:i,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:q.workingColorSpace})}let a=A.state.transmissionRenderTarget[r.id],o=r.viewport||P;a.setSize(o.z*M.transmissionResolutionScale,o.w*M.transmissionResolutionScale);let s=M.getRenderTarget(),u=M.getActiveCubeFace(),d=M.getActiveMipmapLevel();M.setRenderTarget(a),M.getClearColor(fe),pe=M.getClearAlpha(),pe<1&&M.setClearColor(16777215,.5),M.clear(),Oe&&Ke.render(n);let f=M.toneMapping;M.toneMapping=0;let p=r.viewport;if(r.viewport!==void 0&&(r.viewport=void 0),A.setupLightsView(r),Se===!0&&Ue.setGlobalState(M.clippingPlanes,r),_t(e,n,r),B.updateMultisampleRenderTarget(a),B.updateRenderTargetMipmap(a),L.has(`WEBGL_multisampled_render_to_texture`)===!1){let e=!1;for(let i=0,a=t.length;i<a;i++){let{object:a,geometry:o,material:s,group:c}=t[i];if(s.side===2&&a.layers.test(r.layers)){let t=s.side;s.side=1,s.needsUpdate=!0,vt(a,n,r,o,s,c),s.side=t,s.needsUpdate=!0,e=!0}}e===!0&&(B.updateMultisampleRenderTarget(a),B.updateRenderTargetMipmap(a))}M.setRenderTarget(s,u,d),M.setClearColor(fe,pe),p!==void 0&&(r.viewport=p),M.toneMapping=f}function _t(e,t,n){let r=t.isScene===!0?t.overrideMaterial:null;for(let i=0,a=e.length;i<a;i++){let a=e[i],{object:o,geometry:s,group:c}=a,l=a.material;l.allowOverride===!0&&r!==null&&(l=r),o.layers.test(n.layers)&&vt(o,t,n,s,l,c)}}function vt(e,t,n,r,i,a){e.onBeforeRender(M,t,n,r,i,a),e.modelViewMatrix.multiplyMatrices(n.matrixWorldInverse,e.matrixWorld),e.normalMatrix.getNormalMatrix(e.modelViewMatrix),i.onBeforeRender(M,t,n,r,e,a),i.transparent===!0&&i.side===2&&i.forceSinglePass===!1?(i.side=1,i.needsUpdate=!0,M.renderBufferDirect(n,t,r,i,e,a),i.side=0,i.needsUpdate=!0,M.renderBufferDirect(n,t,r,i,e,a),i.side=2):M.renderBufferDirect(n,t,r,i,e,a),e.onAfterRender(M,t,n,r,i,a)}function yt(e,t,n){t.isScene!==!0&&(t=De);let r=z.get(e),i=A.state.lights,a=A.state.shadowsArray,o=i.state.version,s=Re.getParameters(e,i.state,a,t,n,A.state.lightProbeGridArray),c=Re.getProgramCacheKey(s),l=r.programs;r.environment=e.isMeshStandardMaterial||e.isMeshLambertMaterial||e.isMeshPhongMaterial?t.environment:null,r.fog=t.fog;let u=e.isMeshStandardMaterial||e.isMeshLambertMaterial&&!e.envMap||e.isMeshPhongMaterial&&!e.envMap;r.envMap=Ne.get(e.envMap||r.environment,u),r.envMapRotation=r.environment!==null&&e.envMap===null?t.environmentRotation:e.envMapRotation,l===void 0&&(e.addEventListener(`dispose`,at),l=new Map,r.programs=l);let d=l.get(c);if(d!==void 0){if(r.currentProgram===d&&r.lightsStateVersion===o)return xt(e,s),d}else s.uniforms=Re.getUniforms(e),ae!==null&&e.isNodeMaterial&&ae.build(e,n,s),e.onBeforeCompile(s,M),d=Re.acquireProgram(s,c),l.set(c,d),r.uniforms=s.uniforms;let f=r.uniforms;return(!e.isShaderMaterial&&!e.isRawShaderMaterial||e.clipping===!0)&&(f.clippingPlanes=Ue.uniform),xt(e,s),r.needsLights=Tt(e),r.lightsStateVersion=o,r.needsLights&&(f.ambientLightColor.value=i.state.ambient,f.lightProbe.value=i.state.probe,f.directionalLights.value=i.state.directional,f.directionalLightShadows.value=i.state.directionalShadow,f.spotLights.value=i.state.spot,f.spotLightShadows.value=i.state.spotShadow,f.rectAreaLights.value=i.state.rectArea,f.ltc_1.value=i.state.rectAreaLTC1,f.ltc_2.value=i.state.rectAreaLTC2,f.pointLights.value=i.state.point,f.pointLightShadows.value=i.state.pointShadow,f.hemisphereLights.value=i.state.hemi,f.directionalShadowMatrix.value=i.state.directionalShadowMatrix,f.spotLightMatrix.value=i.state.spotLightMatrix,f.spotLightMap.value=i.state.spotLightMap,f.pointShadowMatrix.value=i.state.pointShadowMatrix),r.lightProbeGrid=A.state.lightProbeGridArray.length>0,r.currentProgram=d,r.uniformsList=null,d}function bt(e){if(e.uniformsList===null){let t=e.currentProgram.getUniforms();e.uniformsList=ac.seqWithValue(t.seq,e.uniforms)}return e.uniformsList}function xt(e,t){let n=z.get(e);n.outputColorSpace=t.outputColorSpace,n.batching=t.batching,n.batchingColor=t.batchingColor,n.instancing=t.instancing,n.instancingColor=t.instancingColor,n.instancingMorph=t.instancingMorph,n.skinning=t.skinning,n.morphTargets=t.morphTargets,n.morphNormals=t.morphNormals,n.morphColors=t.morphColors,n.morphTargetsCount=t.morphTargetsCount,n.numClippingPlanes=t.numClippingPlanes,n.numIntersection=t.numClipIntersection,n.vertexAlphas=t.vertexAlphas,n.vertexTangents=t.vertexTangents,n.toneMapping=t.toneMapping}function St(e,t){if(e.length===0)return null;if(e.length===1)return e[0].texture===null?null:e[0];D.setFromMatrixPosition(t.matrixWorld);for(let t=0,n=e.length;t<n;t++){let n=e[t];if(n.texture!==null&&n.boundingBox.containsPoint(D))return n}return null}function Ct(e,t,n,r,i){t.isScene!==!0&&(t=De),B.resetTextureUnits();let a=t.fog,o=r.isMeshStandardMaterial||r.isMeshLambertMaterial||r.isMeshPhongMaterial?t.environment:null,s=N===null?M.outputColorSpace:N.isXRRenderTarget===!0?N.texture.colorSpace:q.workingColorSpace,c=r.isMeshStandardMaterial||r.isMeshLambertMaterial&&!r.envMap||r.isMeshPhongMaterial&&!r.envMap,l=Ne.get(r.envMap||o,c),u=r.vertexColors===!0&&!!n.attributes.color&&n.attributes.color.itemSize===4,d=!!n.attributes.tangent&&(!!r.normalMap||r.anisotropy>0),f=!!n.morphAttributes.position,p=!!n.morphAttributes.normal,m=!!n.morphAttributes.color,h=0;r.toneMapped&&(N===null||N.isXRRenderTarget===!0)&&(h=M.toneMapping);let g=n.morphAttributes.position||n.morphAttributes.normal||n.morphAttributes.color,_=g===void 0?0:g.length,v=z.get(r),y=A.state.lights;if(Se===!0&&(Ce===!0||e!==le)){let t=e===le&&r.id===ce;Ue.setState(r,e,t)}let b=!1;r.version===v.__version?v.needsLights&&v.lightsStateVersion!==y.state.version?b=!0:v.outputColorSpace===s?i.isBatchedMesh&&v.batching===!1||!i.isBatchedMesh&&v.batching===!0||i.isBatchedMesh&&v.batchingColor===!0&&i.colorTexture===null||i.isBatchedMesh&&v.batchingColor===!1&&i.colorTexture!==null||i.isInstancedMesh&&v.instancing===!1||!i.isInstancedMesh&&v.instancing===!0||i.isSkinnedMesh&&v.skinning===!1||!i.isSkinnedMesh&&v.skinning===!0||i.isInstancedMesh&&v.instancingColor===!0&&i.instanceColor===null||i.isInstancedMesh&&v.instancingColor===!1&&i.instanceColor!==null||i.isInstancedMesh&&v.instancingMorph===!0&&i.morphTexture===null||i.isInstancedMesh&&v.instancingMorph===!1&&i.morphTexture!==null?b=!0:v.envMap===l?r.fog===!0&&v.fog!==a||v.numClippingPlanes!==void 0&&(v.numClippingPlanes!==Ue.numPlanes||v.numIntersection!==Ue.numIntersection)?b=!0:v.vertexAlphas===u&&v.vertexTangents===d&&v.morphTargets===f&&v.morphNormals===p&&v.morphColors===m&&v.toneMapping===h&&v.morphTargetsCount===_?!!v.lightProbeGrid!=A.state.lightProbeGridArray.length>0&&(b=!0):b=!0:b=!0:b=!0:(b=!0,v.__version=r.version);let x=v.currentProgram;b===!0&&(x=yt(r,t,i),ae&&r.isNodeMaterial&&ae.onUpdateProgram(r,x,v));let S=!1,C=!1,w=!1,T=x.getUniforms(),E=v.uniforms;if(R.useProgram(x.program)&&(S=!0,C=!0,w=!0),r.id!==ce&&(ce=r.id,C=!0),v.needsLights){let e=St(A.state.lightProbeGridArray,i);v.lightProbeGrid!==e&&(v.lightProbeGrid=e,C=!0)}if(S||le!==e){R.buffers.depth.getReversed()&&e.reversedDepth!==!0&&(e._reversedDepth=!0,e.updateProjectionMatrix()),T.setValue(I,`projectionMatrix`,e.projectionMatrix),T.setValue(I,`viewMatrix`,e.matrixWorldInverse);let t=T.map.cameraPosition;t!==void 0&&t.setValue(I,Te.setFromMatrixPosition(e.matrixWorld)),je.logarithmicDepthBuffer&&T.setValue(I,`logDepthBufFC`,2/(Math.log(e.far+1)/Math.LN2)),(r.isMeshPhongMaterial||r.isMeshToonMaterial||r.isMeshLambertMaterial||r.isMeshBasicMaterial||r.isMeshStandardMaterial||r.isShaderMaterial)&&T.setValue(I,`isOrthographic`,e.isOrthographicCamera===!0),le!==e&&(le=e,C=!0,w=!0)}if(v.needsLights&&(y.state.directionalShadowMap.length>0&&T.setValue(I,`directionalShadowMap`,y.state.directionalShadowMap,B),y.state.spotShadowMap.length>0&&T.setValue(I,`spotShadowMap`,y.state.spotShadowMap,B),y.state.pointShadowMap.length>0&&T.setValue(I,`pointShadowMap`,y.state.pointShadowMap,B)),i.isSkinnedMesh){T.setOptional(I,i,`bindMatrix`),T.setOptional(I,i,`bindMatrixInverse`);let e=i.skeleton;e&&(e.boneTexture===null&&e.computeBoneTexture(),T.setValue(I,`boneTexture`,e.boneTexture,B))}i.isBatchedMesh&&(T.setOptional(I,i,`batchingTexture`),T.setValue(I,`batchingTexture`,i._matricesTexture,B),T.setOptional(I,i,`batchingIdTexture`),T.setValue(I,`batchingIdTexture`,i._indirectTexture,B),T.setOptional(I,i,`batchingColorTexture`),i._colorsTexture!==null&&T.setValue(I,`batchingColorTexture`,i._colorsTexture,B));let D=n.morphAttributes;if((D.position!==void 0||D.normal!==void 0||D.color!==void 0)&&qe.update(i,n,x),(C||v.receiveShadow!==i.receiveShadow)&&(v.receiveShadow=i.receiveShadow,T.setValue(I,`receiveShadow`,i.receiveShadow)),(r.isMeshStandardMaterial||r.isMeshLambertMaterial||r.isMeshPhongMaterial)&&r.envMap===null&&t.environment!==null&&(E.envMapIntensity.value=t.environmentIntensity),E.dfgLUT!==void 0&&(E.dfgLUT.value=El()),C){if(T.setValue(I,`toneMappingExposure`,M.toneMappingExposure),v.needsLights&&wt(E,w),a&&r.fog===!0&&ze.refreshFogUniforms(E,a),ze.refreshMaterialUniforms(E,r,F,he,A.state.transmissionRenderTarget[e.id]),v.needsLights&&v.lightProbeGrid){let e=v.lightProbeGrid;E.probesSH.value=e.texture,E.probesMin.value.copy(e.boundingBox.min),E.probesMax.value.copy(e.boundingBox.max),E.probesResolution.value.copy(e.resolution)}ac.upload(I,bt(v),E,B)}if(r.isShaderMaterial&&r.uniformsNeedUpdate===!0&&(ac.upload(I,bt(v),E,B),r.uniformsNeedUpdate=!1),r.isSpriteMaterial&&T.setValue(I,`center`,i.center),T.setValue(I,`modelViewMatrix`,i.modelViewMatrix),T.setValue(I,`normalMatrix`,i.normalMatrix),T.setValue(I,`modelMatrix`,i.matrixWorld),r.uniformsGroups!==void 0){let e=r.uniformsGroups;for(let t=0,n=e.length;t<n;t++){let n=e[t];et.update(n,x),et.bind(n,x)}}return x}function wt(e,t){e.ambientLightColor.needsUpdate=t,e.lightProbe.needsUpdate=t,e.directionalLights.needsUpdate=t,e.directionalLightShadows.needsUpdate=t,e.pointLights.needsUpdate=t,e.pointLightShadows.needsUpdate=t,e.spotLights.needsUpdate=t,e.spotLightShadows.needsUpdate=t,e.rectAreaLights.needsUpdate=t,e.hemisphereLights.needsUpdate=t}function Tt(e){return e.isMeshLambertMaterial||e.isMeshToonMaterial||e.isMeshPhongMaterial||e.isMeshStandardMaterial||e.isShadowMaterial||e.isShaderMaterial&&e.lights===!0}this.getActiveCubeFace=function(){return oe},this.getActiveMipmapLevel=function(){return se},this.getRenderTarget=function(){return N},this.setRenderTargetTextures=function(e,t,n){let r=z.get(e);r.__autoAllocateDepthBuffer=e.resolveDepthBuffer===!1,r.__autoAllocateDepthBuffer===!1&&(r.__useRenderToTexture=!1),z.get(e.texture).__webglTexture=t,z.get(e.depthTexture).__webglTexture=r.__autoAllocateDepthBuffer?void 0:n,r.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(e,t){let n=z.get(e);n.__webglFramebuffer=t,n.__useDefaultFramebuffer=t===void 0};let W=I.createFramebuffer();this.setRenderTarget=function(e,t=0,n=0){N=e,oe=t,se=n;let r=null,i=!1,a=!1;if(e){let o=z.get(e);if(o.__useDefaultFramebuffer!==void 0){R.bindFramebuffer(I.FRAMEBUFFER,o.__webglFramebuffer),P.copy(e.viewport),ue.copy(e.scissor),de=e.scissorTest,R.viewport(P),R.scissor(ue),R.setScissorTest(de),ce=-1;return}else if(o.__webglFramebuffer===void 0)B.setupRenderTarget(e);else if(o.__hasExternalTextures)B.rebindTextures(e,z.get(e.texture).__webglTexture,z.get(e.depthTexture).__webglTexture);else if(e.depthBuffer){let t=e.depthTexture;if(o.__boundDepthTexture!==t){if(t!==null&&z.has(t)&&(e.width!==t.image.width||e.height!==t.image.height))throw Error(`WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.`);B.setupDepthRenderbuffer(e)}}let s=e.texture;(s.isData3DTexture||s.isDataArrayTexture||s.isCompressedArrayTexture)&&(a=!0);let c=z.get(e).__webglFramebuffer;e.isWebGLCubeRenderTarget?(r=Array.isArray(c[t])?c[t][n]:c[t],i=!0):r=e.samples>0&&B.useMultisampledRTT(e)===!1?z.get(e).__webglMultisampledFramebuffer:Array.isArray(c)?c[n]:c,P.copy(e.viewport),ue.copy(e.scissor),de=e.scissorTest}else P.copy(ve).multiplyScalar(F).floor(),ue.copy(ye).multiplyScalar(F).floor(),de=be;if(n!==0&&(r=W),R.bindFramebuffer(I.FRAMEBUFFER,r)&&R.drawBuffers(e,r),R.viewport(P),R.scissor(ue),R.setScissorTest(de),i){let r=z.get(e.texture);I.framebufferTexture2D(I.FRAMEBUFFER,I.COLOR_ATTACHMENT0,I.TEXTURE_CUBE_MAP_POSITIVE_X+t,r.__webglTexture,n)}else if(a){let r=t;for(let t=0;t<e.textures.length;t++){let i=z.get(e.textures[t]);I.framebufferTextureLayer(I.FRAMEBUFFER,I.COLOR_ATTACHMENT0+t,i.__webglTexture,n,r)}}else if(e!==null&&n!==0){let t=z.get(e.texture);I.framebufferTexture2D(I.FRAMEBUFFER,I.COLOR_ATTACHMENT0,I.TEXTURE_2D,t.__webglTexture,n)}ce=-1},this.readRenderTargetPixels=function(e,t,n,r,i,a,o,s=0){if(!(e&&e.isWebGLRenderTarget)){H(`WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.`);return}let c=z.get(e).__webglFramebuffer;if(e.isWebGLCubeRenderTarget&&o!==void 0&&(c=c[o]),c){R.bindFramebuffer(I.FRAMEBUFFER,c);try{let o=e.textures[s],c=o.format,l=o.type;if(e.textures.length>1&&I.readBuffer(I.COLOR_ATTACHMENT0+s),!je.textureFormatReadable(c)){H(`WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.`);return}if(!je.textureTypeReadable(l)){H(`WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.`);return}t>=0&&t<=e.width-r&&n>=0&&n<=e.height-i&&I.readPixels(t,n,r,i,Qe.convert(c),Qe.convert(l),a)}finally{let e=N===null?null:z.get(N).__webglFramebuffer;R.bindFramebuffer(I.FRAMEBUFFER,e)}}},this.readRenderTargetPixelsAsync=async function(e,t,n,r,i,a,o,s=0){if(!(e&&e.isWebGLRenderTarget))throw Error(`THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.`);let c=z.get(e).__webglFramebuffer;if(e.isWebGLCubeRenderTarget&&o!==void 0&&(c=c[o]),c)if(t>=0&&t<=e.width-r&&n>=0&&n<=e.height-i){R.bindFramebuffer(I.FRAMEBUFFER,c);let o=e.textures[s],l=o.format,u=o.type;if(e.textures.length>1&&I.readBuffer(I.COLOR_ATTACHMENT0+s),!je.textureFormatReadable(l))throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.`);if(!je.textureTypeReadable(u))throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.`);let d=I.createBuffer();I.bindBuffer(I.PIXEL_PACK_BUFFER,d),I.bufferData(I.PIXEL_PACK_BUFFER,a.byteLength,I.STREAM_READ),I.readPixels(t,n,r,i,Qe.convert(l),Qe.convert(u),0);let f=N===null?null:z.get(N).__webglFramebuffer;R.bindFramebuffer(I.FRAMEBUFFER,f);let p=I.fenceSync(I.SYNC_GPU_COMMANDS_COMPLETE,0);return I.flush(),await Ze(I,p,4),I.bindBuffer(I.PIXEL_PACK_BUFFER,d),I.getBufferSubData(I.PIXEL_PACK_BUFFER,0,a),I.deleteBuffer(d),I.deleteSync(p),a}else throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.`)},this.copyFramebufferToTexture=function(e,t=null,n=0){let r=2**-n,i=Math.floor(e.image.width*r),a=Math.floor(e.image.height*r),o=t===null?0:t.x,s=t===null?0:t.y;B.setTexture2D(e,0),I.copyTexSubImage2D(I.TEXTURE_2D,n,0,0,o,s,i,a),R.unbindTexture()};let Et=I.createFramebuffer(),Dt=I.createFramebuffer();this.copyTextureToTexture=function(e,t,n=null,r=null,i=0,a=0){let o,s,c,l,u,d,f,p,m,h=e.isCompressedTexture?e.mipmaps[a]:e.image;if(n!==null)o=n.max.x-n.min.x,s=n.max.y-n.min.y,c=n.isBox3?n.max.z-n.min.z:1,l=n.min.x,u=n.min.y,d=n.isBox3?n.min.z:0;else{let t=2**-i;o=Math.floor(h.width*t),s=Math.floor(h.height*t),c=e.isDataArrayTexture?h.depth:e.isData3DTexture?Math.floor(h.depth*t):1,l=0,u=0,d=0}r===null?(f=0,p=0,m=0):(f=r.x,p=r.y,m=r.z);let g=Qe.convert(t.format),_=Qe.convert(t.type),v;t.isData3DTexture?(B.setTexture3D(t,0),v=I.TEXTURE_3D):t.isDataArrayTexture||t.isCompressedArrayTexture?(B.setTexture2DArray(t,0),v=I.TEXTURE_2D_ARRAY):(B.setTexture2D(t,0),v=I.TEXTURE_2D),R.activeTexture(I.TEXTURE0),R.pixelStorei(I.UNPACK_FLIP_Y_WEBGL,t.flipY),R.pixelStorei(I.UNPACK_PREMULTIPLY_ALPHA_WEBGL,t.premultiplyAlpha),R.pixelStorei(I.UNPACK_ALIGNMENT,t.unpackAlignment);let y=R.getParameter(I.UNPACK_ROW_LENGTH),b=R.getParameter(I.UNPACK_IMAGE_HEIGHT),x=R.getParameter(I.UNPACK_SKIP_PIXELS),S=R.getParameter(I.UNPACK_SKIP_ROWS),C=R.getParameter(I.UNPACK_SKIP_IMAGES);R.pixelStorei(I.UNPACK_ROW_LENGTH,h.width),R.pixelStorei(I.UNPACK_IMAGE_HEIGHT,h.height),R.pixelStorei(I.UNPACK_SKIP_PIXELS,l),R.pixelStorei(I.UNPACK_SKIP_ROWS,u),R.pixelStorei(I.UNPACK_SKIP_IMAGES,d);let w=e.isDataArrayTexture||e.isData3DTexture,T=t.isDataArrayTexture||t.isData3DTexture;if(e.isDepthTexture){let n=z.get(e),r=z.get(t),h=z.get(n.__renderTarget),g=z.get(r.__renderTarget);R.bindFramebuffer(I.READ_FRAMEBUFFER,h.__webglFramebuffer),R.bindFramebuffer(I.DRAW_FRAMEBUFFER,g.__webglFramebuffer);for(let n=0;n<c;n++)w&&(I.framebufferTextureLayer(I.READ_FRAMEBUFFER,I.COLOR_ATTACHMENT0,z.get(e).__webglTexture,i,d+n),I.framebufferTextureLayer(I.DRAW_FRAMEBUFFER,I.COLOR_ATTACHMENT0,z.get(t).__webglTexture,a,m+n)),I.blitFramebuffer(l,u,o,s,f,p,o,s,I.DEPTH_BUFFER_BIT,I.NEAREST);R.bindFramebuffer(I.READ_FRAMEBUFFER,null),R.bindFramebuffer(I.DRAW_FRAMEBUFFER,null)}else if(i!==0||e.isRenderTargetTexture||z.has(e)){let n=z.get(e),r=z.get(t);R.bindFramebuffer(I.READ_FRAMEBUFFER,Et),R.bindFramebuffer(I.DRAW_FRAMEBUFFER,Dt);for(let e=0;e<c;e++)w?I.framebufferTextureLayer(I.READ_FRAMEBUFFER,I.COLOR_ATTACHMENT0,n.__webglTexture,i,d+e):I.framebufferTexture2D(I.READ_FRAMEBUFFER,I.COLOR_ATTACHMENT0,I.TEXTURE_2D,n.__webglTexture,i),T?I.framebufferTextureLayer(I.DRAW_FRAMEBUFFER,I.COLOR_ATTACHMENT0,r.__webglTexture,a,m+e):I.framebufferTexture2D(I.DRAW_FRAMEBUFFER,I.COLOR_ATTACHMENT0,I.TEXTURE_2D,r.__webglTexture,a),i===0?T?I.copyTexSubImage3D(v,a,f,p,m+e,l,u,o,s):I.copyTexSubImage2D(v,a,f,p,l,u,o,s):I.blitFramebuffer(l,u,o,s,f,p,o,s,I.COLOR_BUFFER_BIT,I.NEAREST);R.bindFramebuffer(I.READ_FRAMEBUFFER,null),R.bindFramebuffer(I.DRAW_FRAMEBUFFER,null)}else T?e.isDataTexture||e.isData3DTexture?I.texSubImage3D(v,a,f,p,m,o,s,c,g,_,h.data):t.isCompressedArrayTexture?I.compressedTexSubImage3D(v,a,f,p,m,o,s,c,g,h.data):I.texSubImage3D(v,a,f,p,m,o,s,c,g,_,h):e.isDataTexture?I.texSubImage2D(I.TEXTURE_2D,a,f,p,o,s,g,_,h.data):e.isCompressedTexture?I.compressedTexSubImage2D(I.TEXTURE_2D,a,f,p,h.width,h.height,g,h.data):I.texSubImage2D(I.TEXTURE_2D,a,f,p,o,s,g,_,h);R.pixelStorei(I.UNPACK_ROW_LENGTH,y),R.pixelStorei(I.UNPACK_IMAGE_HEIGHT,b),R.pixelStorei(I.UNPACK_SKIP_PIXELS,x),R.pixelStorei(I.UNPACK_SKIP_ROWS,S),R.pixelStorei(I.UNPACK_SKIP_IMAGES,C),a===0&&t.generateMipmaps&&I.generateMipmap(v),R.unbindTexture()},this.initRenderTarget=function(e){z.get(e).__webglFramebuffer===void 0&&B.setupRenderTarget(e)},this.initTexture=function(e){e.isCubeTexture?B.setTextureCube(e,0):e.isData3DTexture?B.setTexture3D(e,0):e.isDataArrayTexture||e.isCompressedArrayTexture?B.setTexture2DArray(e,0):B.setTexture2D(e,0),R.unbindTexture()},this.resetState=function(){oe=0,se=0,N=null,R.reset(),$e.reset()},typeof __THREE_DEVTOOLS__<`u`&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent(`observe`,{detail:this}))}get coordinateSystem(){return Ve}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;let t=this.getContext();t.drawingBufferColorSpace=q._getDrawingBufferColorSpace(e),t.unpackColorSpace=q._getUnpackColorSpace()}},Ol={armor:[{name:`Wolf Guard Mail`,emoji:`◆`,color:5201738,accent:14201450,power:{might:3,team:3},title:`Wolf Guard`},{name:`Champion Plate`,emoji:`◈`,color:4085105,accent:14275260,power:{might:5,team:1},title:`Champion`},{name:`Ember Scale Armor`,emoji:`✦`,color:7024418,accent:16751933,power:{might:4,magic:3},title:`Ember Warden`},{name:`Shadow Ranger Leathers`,emoji:`◇`,color:2367798,accent:9403048,power:{speed:5,magic:1},title:`Shadow Ranger`},{name:`Highland Battle Kilt`,emoji:`⬟`,color:3494459,accent:11549486,power:{speed:2,might:4},title:`Highland Hero`}],melee:[{name:`Iron Longsword`,emoji:`⚔`,color:7297595,accent:14144198,power:{might:4,speed:2},title:`Longsword`},{name:`Storm Warhammer`,emoji:`✚`,color:5066837,accent:7320519,power:{might:6,magic:1},title:`Warhammer`},{name:`Rogue Twin Daggers`,emoji:`†`,color:3811874,accent:14004348,power:{speed:6},title:`Daggers`},{name:`Runed Battle Axe`,emoji:`ᛉ`,color:5980456,accent:11056282,power:{might:5,magic:2},title:`Battle Axe`}],ranged:[{name:`Hunter Longbow`,emoji:`➳`,color:5911070,accent:14201450,power:{speed:3,team:2},title:`Longbow`},{name:`Heavy Crossbow`,emoji:`⊹`,color:3944752,accent:12038563,power:{might:3,speed:2},title:`Crossbow`},{name:`Elder Oak Staff`,emoji:`✶`,color:5060646,accent:8245174,power:{magic:6},title:`Elder Staff`},{name:`Soul Lantern Caster`,emoji:`☽`,color:2047816,accent:8246268,power:{team:2,magic:4},title:`Soul Caster`}],partner:[{name:`Armored Wolf`,emoji:`♞`,color:7172461,accent:13218431,power:{team:5,might:1},title:`Wolf-Bonded`},{name:`Hatchling Drake`,emoji:`♜`,color:3232058,accent:12869693,power:{magic:4,might:2},title:`Drake-Keeper`},{name:`Iron Golem Squire`,emoji:`♖`,color:8025709,accent:13287322,power:{team:4,might:2},title:`Golem-Sworn`},{name:`Cave Bat Familiar`,emoji:`✧`,color:3024434,accent:10129328,power:{speed:3,magic:3},title:`Bat-Friend`}],artifact:[{name:`Firework Quiver`,emoji:`✹`,color:9318181,accent:16762967,power:{magic:3,might:3},title:`Firework`},{name:`Totem of Regeneration`,emoji:`✥`,color:7031340,accent:7975021,power:{team:6},title:`Totem-Bearer`},{name:`Boots of Swiftness`,emoji:`↟`,color:5191978,accent:14136426,power:{speed:6},title:`Swift`},{name:`Soul Amulet`,emoji:`☼`,color:1194056,accent:8246268,power:{magic:5,team:1},title:`Soulbound`}],look:[{name:`Village Champion`,emoji:`I`,color:12024661,accent:3810070,power:{team:1},title:`Brave`},{name:`Desert Wanderer`,emoji:`II`,color:10184781,accent:2168335,power:{speed:1},title:`Wanderer`},{name:`Forest Warden`,emoji:`III`,color:12750184,accent:5780765,power:{magic:1},title:`Warden`},{name:`Arcane Adept`,emoji:`IV`,color:10977213,accent:1643298,power:{magic:2},title:`Adept`}]};function kl(e){let t={might:1,speed:1,magic:1,team:1};return Object.keys(Ol).forEach(n=>Object.entries(Ol[n][e[n]].power).forEach(([e,n])=>t[e]+=n??0)),t}function Al(e,t=.55,n=.06){return new la({color:e,roughness:t,metalness:n})}function jl(e,t,n,r,i=.04){let a=new Y(new yi(...t),Al(r,.52,i));return a.name=e,a.position.set(...n),a.castShadow=!0,a.receiveShadow=!0,a}function Ml(e,t,n,r=1){let i=new Y(new Xi(.16*r,0),Al(t,.25,.38));return i.position.set(...n),i.castShadow=!0,e.add(i),i}function Q(e,t){let n=new J(e);return n.multiplyScalar(t),n.getHex()}function Nl(e,t){let n=new J(e);return n.lerp(new J(16777215),t),n.getHex()}function $(e,t,n,r,i,a=.1){let o=jl(t,n,r,i,a);return e.add(o),o}function Pl(e,t,n,r,i){let a=jl(`rune`,[.08,.18,.035],[n,r,i],t,.22);return a.rotation.z=.8,e.add(a),a}function Fl(e,t,n,r,i=2759186){$(e,`leather-strap-a`,[.92,.08,.04],[t,n,r],i,.03).rotation.z=.58,$(e,`leather-strap-b`,[.92,.08,.04],[t,n,r],i,.03).rotation.z=-.58}function Il(e,t,n,r,i,a,o,s=1.1){$(e,`${t}-grip`,[.13,.42,.13],[n,r,i],a,.12),$(e,`${t}-guard`,[.5,.09,.1],[n,r+.26,i],a,.18),$(e,`${t}-blade`,[.2,s,.08],[n,r+.26+s/2,i],o,.42),$(e,`${t}-edge`,[.04,s*.92,.09],[n+.12,r+.32+s/2,i],Nl(o,.35),.48)}var Ll=class{root=new Cn;camera=new Va(42,1,.1,100);fog=new jn(1183243,8,24);state={armor:1,melee:0,ranged:0,partner:0,artifact:0,look:0};photoSkin=null;photoHair=null;hero=new Cn;gear=new Cn;partnerGroup=new Cn;sparkleGroup=new Cn;loadoutGroup=new Cn;body=jl(`body`,[1.18,1.45,.62],[0,.08,0],4085105,.09);head=jl(`head`,[.9,.86,.9],[0,1.35,0],12024661);hair=jl(`hair`,[.96,.28,.96],[0,1.86,0],3810070);leftArm=jl(`left-arm`,[.38,1.12,.42],[-.86,.03,0],12024661);rightArm=jl(`right-arm`,[.38,1.12,.42],[.86,.03,0],12024661);leftLeg=jl(`left-leg`,[.44,1.05,.44],[-.3,-1.13,0],2564380);rightLeg=jl(`right-leg`,[.44,1.05,.44],[.3,-1.13,0],2564380);allyRogue;allyMage;onChange=null;dragging=!1;lastX=0;targetRot=-.18;zoom=8.55;autoZoom=!0;inputEl=null;elapsedMs=0;constructor(){this.root.add(this.hero,this.partnerGroup,this.sparkleGroup,this.loadoutGroup),this.hero.scale.setScalar(.92),this.hero.add(this.gear),this.camera.position.set(4.55,3.35,7.15),this.root.add(new ka(13615006,1511436,1.35));let e=new Ka(16777215,2.5);e.position.set(4,8,5),e.castShadow=!0,this.root.add(e);let t=new Ua(16747570,5.2,12);t.position.set(-3.7,2.1,-2.4),this.root.add(t);let n=new Y(new xi(3.25,3.7,.42,8),Al(3090465,.74,.02));n.position.y=-1.42,n.receiveShadow=!0,this.root.add(n),this.buildBody(),this.makeDungeonSet(),this.makePortalSet(),this.makeAllies(),this.refreshGear()}buildBody(){this.leftArm.rotation.z=.12,this.rightArm.rotation.z=-.54,this.hero.add(this.body,this.head,this.hair,this.leftArm,this.rightArm,this.leftLeg,this.rightLeg);let e=new Cn,t=new yi(.12,.14,.035),n=new Y(t,Al(1120295));n.position.set(-.18,1.47,.47);let r=new Y(t,Al(1120295));r.position.set(.18,1.47,.47);let i=new Y(new yi(.18,.045,.035),Al(2758929));i.position.set(-.18,1.58,.47),i.rotation.z=-.18;let a=new Y(new yi(.18,.045,.035),Al(2758929));a.position.set(.18,1.58,.47),a.rotation.z=.18;let o=new Y(new yi(.28,.045,.035),Al(4857624));o.position.set(0,1.18,.47),e.add(n,r,i,a,o),this.hero.add(e)}refreshGear(){let{gear:e,partnerGroup:t,sparkleGroup:n,loadoutGroup:r,state:i}=this;e.clear(),t.clear(),n.clear(),r.clear();let a=Ol.armor[i.armor],o=Ol.melee[i.melee],s=Ol.ranged[i.ranged],c=s.name.toLowerCase(),l=Ol.artifact[i.artifact],u=Ol.look[i.look];this.body.material=Al(a.color,.48,.14),this.head.material=Al(this.photoSkin??u.color,.58,.02),this.leftArm.material=Al(this.photoSkin??u.color,.58,.02),this.rightArm.material=Al(this.photoSkin??u.color,.58,.02),this.hair.material=Al(this.photoHair??u.accent,.7,.02),this.leftLeg.material=Al(Q(a.color,.42),.62,.04),this.rightLeg.material=Al(Q(a.color,.42),.62,.04),$(e,`cloak`,[1.3,1.9,.1],[0,-.05,-.43],Q(a.color,.5),.02),$(e,`cloak-hem`,[1.18,.08,.12],[0,-.98,-.39],a.accent,.08),$(e,`helmet`,[1.05,.3,1.05],[0,1.88,0],a.accent,.14),$(e,`helmet-crown`,[.72,.12,1.08],[0,2.1,0],Nl(a.accent,.08),.18),$(e,`helmet-side-l`,[.16,.42,.2],[-.52,1.63,.12],Q(a.accent,.72),.14),$(e,`helmet-side-r`,[.16,.42,.2],[.52,1.63,.12],Q(a.accent,.72),.14),$(e,`brow-guard`,[1,.16,.22],[0,1.64,.47],Q(a.accent,.7),.2),$(e,`left-pauldron`,[.5,.34,.7],[-.78,.66,0],a.accent,.2),$(e,`right-pauldron`,[.5,.34,.7],[.78,.66,0],a.accent,.2),$(e,`chest-plate`,[1.02,.72,.09],[0,.24,.37],Q(a.accent,.86),.22),$(e,`chest-highlight`,[.88,.08,.11],[0,.55,.43],Nl(a.accent,.12),.24);for(let t of[-.36,-.12,.12,.36])$(e,`armor-rivet`,[.07,.07,.055],[t,.49,.47],Nl(a.accent,.22),.28),$(e,`armor-rivet-low`,[.06,.06,.055],[t*.82,.05,.47],Q(a.accent,.7),.2);$(e,`plate-seam-left`,[.06,.62,.045],[-.31,.22,.46],Q(a.color,.5),.06),$(e,`plate-seam-right`,[.06,.62,.045],[.31,.22,.46],Q(a.color,.5),.06),$(e,`belt`,[1.22,.18,.66],[0,-.43,0],Q(a.accent,.52),.12),$(e,`belt-buckle`,[.22,.22,.11],[0,-.42,.39],Nl(a.accent,.18),.26),$(e,`tunic-left`,[.46,.5,.08],[-.25,-.76,.35],Q(a.color,.62),.04),$(e,`tunic-right`,[.46,.5,.08],[.25,-.76,.35],Q(a.color,.62),.04),$(e,`left-bracer`,[.42,.24,.46],[-.86,-.22,0],a.accent,.14),$(e,`right-bracer`,[.42,.24,.46],[.86,-.22,0],a.accent,.14),$(e,`left-boot`,[.5,.22,.5],[-.3,-1.76,.03],a.accent,.12),$(e,`right-boot`,[.5,.22,.5],[.3,-1.76,.03],a.accent,.12),Pl(e,Nl(a.accent,.2),-.23,.28,.43),Pl(e,Nl(a.accent,.2),.23,.28,.43),Fl(e,0,.04,.44);let d=new Cn,f=c.includes(`bow`)||c.includes(`crossbow`)||c.includes(`staff`);if(d.position.set(f?.95:.72,f?-.82:.04,f?-.5:.22),d.rotation.z=f?-1.08:-.5,d.scale.setScalar(f?.5:1),o.name.includes(`Hammer`))$(d,`hammer-grip`,[.14,1.28,.14],[.12,.36,0],o.color,.1),$(d,`hammer-core`,[.66,.34,.34],[.12,1.13,0],o.accent,.28),$(d,`hammer-cap-l`,[.16,.42,.42],[-.29,1.13,0],Nl(o.accent,.16),.32),$(d,`hammer-cap-r`,[.16,.42,.42],[.53,1.13,0],Q(o.accent,.8),.26);else if(o.name.includes(`Daggers`)){Il(d,`dagger-right`,.18,.26,.08,o.color,o.accent,.62);let t=new Cn;Il(t,`dagger-left`,-.42,-.26,.1,o.color,o.accent,.58),t.rotation.z=1.35,e.add(t)}else o.name.includes(`Axe`)?($(d,`axe-grip`,[.14,1.28,.14],[.12,.42,0],o.color,.08),$(d,`axe-head`,[.58,.52,.12],[.34,1.16,0],o.accent,.32),$(d,`axe-beard`,[.22,.42,.12],[.08,.96,0],Nl(o.accent,.16),.32)):Il(d,`longsword`,.1,.24,.02,o.color,o.accent,1.12);e.add(d),$(e,`right-hand-grip`,[.24,.2,.24],[f?.52:.88,f?.2:.14,f?.86:.34],this.photoSkin??u.color,.02);let p=new Cn;if(p.position.set(-.72,.18,-.04),c.includes(`bow`)){p.position.set(-.78,.32,1.24),p.rotation.z=-.08,p.rotation.y=-.04,p.scale.setScalar(1.18);let t=Al(s.color,.5,.08),n=new Y(new Qi(new Mi([new G(-.08,1.08,0),new G(-.42,.62,0),new G(-.56,0,0),new G(-.42,-.62,0),new G(-.08,-1.08,0)]),18,.045,8,!1),t);n.castShadow=!0,n.receiveShadow=!0,p.add(n);let i=$(p,`bow-tip-top`,[.2,.08,.1],[-.13,1,0],s.accent,.12);i.rotation.z=-.35;let a=$(p,`bow-tip-bottom`,[.2,.08,.1],[-.13,-1,0],s.accent,.12);a.rotation.z=.35,$(p,`bow-grip`,[.18,.36,.14],[-.5,0,.05],s.accent,.14),$(p,`bow-leather-wrap-a`,[.24,.055,.16],[-.5,.12,.11],Q(s.color,.62),.06),$(p,`bow-leather-wrap-b`,[.24,.055,.16],[-.5,-.12,.11],Q(s.color,.62),.06);let o=new Lr({color:16317180}),c=new Y(new yi(.035,1.92,.035),o);c.position.set(.08,0,.08),p.add(c),$(p,`nocked-arrow-shaft`,[1.36,.06,.06],[-.38,.02,.34],15122810,.12),$(p,`nocked-arrow-head`,[.2,.16,.12],[.36,.02,.34],Nl(s.accent,.28),.24),$(p,`arrow-fletch-a`,[.16,.07,.11],[-1.08,.11,.34],s.accent,.08).rotation.z=.5,$(p,`arrow-fletch-b`,[.16,.07,.11],[-1.08,-.07,.34],s.accent,.08).rotation.z=-.5,$(p,`spare-arrow-shaft-a`,[.95,.045,.045],[-.18,-.24,-.08],15122810,.08).rotation.z=-.16,$(p,`spare-arrow-shaft-b`,[.95,.045,.045],[-.15,-.38,-.08],15122810,.08).rotation.z=-.16,$(e,`bow-left-hand`,[.28,.22,.26],[-.92,.34,1.14],this.photoSkin??u.color,.02),$(e,`bow-right-hand`,[.28,.22,.26],[.18,.2,1.2],this.photoSkin??u.color,.02),$(e,`arrow-pull-hand`,[.24,.2,.22],[-.18,.02,1.28],this.photoSkin??u.color,.02);let l=$(e,`visible-longbow-top`,[.18,1.2,.18],[-1.72,.9,1.76],Nl(s.color,.16),.1);l.rotation.z=-.24;let d=$(e,`visible-longbow-bottom`,[.18,1.2,.18],[-1.72,-.32,1.76],Nl(s.color,.16),.1);d.rotation.z=.24,$(e,`visible-longbow-grip`,[.26,.4,.22],[-1.48,.28,1.86],s.accent,.16),$(e,`visible-longbow-string`,[.045,2.35,.05],[-1.26,.28,1.96],16317180,0),$(e,`visible-longbow-arrow`,[1.3,.07,.07],[-.86,.28,2.02],15122810,.12),$(e,`visible-longbow-arrowhead`,[.18,.14,.1],[-.26,.28,2.02],Nl(s.accent,.28),.24);let f=new Cn;f.position.set(1.82,.12,1.52),f.rotation.y=.22,f.scale.setScalar(1.35);let m=$(f,`showcase-longbow-top`,[.16,1,.16],[-.18,.56,0],16751918,.12);m.rotation.z=-.35;let h=$(f,`showcase-longbow-bottom`,[.16,1,.16],[-.18,-.52,0],16751918,.12);h.rotation.z=.35,$(f,`showcase-longbow-string`,[.06,1.96,.06],[.24,.02,.06],16317180,0),$(f,`showcase-longbow-grip`,[.24,.36,.2],[-.08,.02,.1],s.accent,.16),$(f,`showcase-arrow-shaft`,[.96,.06,.06],[0,.02,.24],15122810,.1),$(f,`showcase-arrow-head`,[.18,.14,.1],[.54,.02,.24],Nl(s.accent,.28),.24),r.add(f)}else if(c.includes(`crossbow`)){p.position.set(-.04,.28,.92),p.rotation.z=-.04;let t=s.color,n=s.accent;$(p,`crossbow-main-stock`,[1.28,.2,.24],[.08,0,.16],t,.12),$(p,`crossbow-butt`,[.24,.34,.24],[.78,-.02,.15],Q(t,.65),.08),$(p,`crossbow-front-block`,[.28,.34,.28],[-.58,0,.2],Q(t,.72),.12),$(p,`crossbow-upper-limb`,[.22,.78,.12],[-.68,.44,.24],n,.22).rotation.z=.18,$(p,`crossbow-lower-limb`,[.22,.78,.12],[-.68,-.44,.24],n,.22).rotation.z=-.18,$(p,`crossbow-tip-top`,[.34,.14,.13],[-.78,.86,.24],Nl(n,.18),.24),$(p,`crossbow-tip-bottom`,[.34,.14,.13],[-.78,-.86,.24],Nl(n,.18),.24),$(p,`crossbow-string-visible`,[.035,1.72,.04],[-.36,0,.36],16317180,0),$(p,`crossbow-top-rail`,[1.52,.07,.1],[.06,.11,.42],Nl(t,.15),.16),$(p,`crossbow-bolt-shaft`,[1.62,.07,.07],[.02,.16,.58],14201450,.2),$(p,`crossbow-bolt-head`,[.2,.16,.12],[.94,.16,.58],14144198,.28),$(p,`crossbow-fletch-a`,[.16,.07,.1],[-.78,.25,.58],n,.12).rotation.z=.5,$(p,`crossbow-fletch-b`,[.16,.07,.1],[-.78,.06,.58],n,.12).rotation.z=-.5,$(p,`crossbow-trigger`,[.14,.28,.12],[.24,-.23,.34],1708043,.08),$(e,`left-crossbow-hand`,[.28,.22,.26],[-.48,.22,.94],this.photoSkin??u.color,.02),$(e,`right-crossbow-hand`,[.28,.22,.26],[.38,.18,.94],this.photoSkin??u.color,.02)}else if(c.includes(`staff`)){p.position.set(.86,.1,1.06),p.rotation.z=-.08,$(p,`held-staff-shaft`,[.13,2.18,.13],[0,.08,0],s.color,.1),$(p,`held-staff-highlight`,[.045,2,.04],[.055,.08,.075],16751918,.03),$(p,`held-staff-butt-cap`,[.24,.14,.16],[0,-1.02,0],Q(s.accent,.72),.12);for(let e of[-.42,-.18,.08,.34])$(p,`staff-leather-wrap`,[.22,.075,.16],[0,e,.02],5911330,.08);$(p,`elder-oak-crown`,[.42,.24,.2],[0,1.23,0],Q(s.color,.66),.18),$(p,`staff-branch-left`,[.09,.58,.09],[-.27,1.18,0],s.color,.08).rotation.z=-.62,$(p,`staff-branch-right`,[.09,.58,.09],[.27,1.18,0],s.color,.08).rotation.z=.62,Ml(p,s.accent,[0,1.5,.08],1.35),$(p,`magic-bolt-1`,[.38,.08,.08],[.42,1.48,.12],Nl(s.accent,.28),.2).rotation.z=.22,$(p,`magic-bolt-2`,[.32,.07,.07],[-.38,1.42,.12],Nl(s.accent,.18),.2).rotation.z=-.3,$(e,`staff-main-hand-back`,[.34,.24,.16],[.8,.12,.98],Q(this.photoSkin??u.color,.78),.04),$(e,`staff-main-hand-front`,[.34,.24,.14],[.93,.12,1.18],this.photoSkin??u.color,.04),$(e,`staff-support-hand-back`,[.28,.22,.15],[.62,-.38,.94],Q(this.photoSkin??u.color,.78),.04),$(e,`staff-support-hand-front`,[.28,.22,.13],[.74,-.38,1.14],this.photoSkin??u.color,.04);let t=new Ua(s.accent,2.8,4.8);t.position.set(0,1.5,.28),p.add(t)}else{$(p,`lantern-handle`,[.08,.72,.08],[-.12,.38,.18],s.color,.08),$(p,`lantern-cage`,[.34,.48,.34],[-.12,-.08,.18],Q(s.color,.75),.16);let e=new Y(new yi(.24,.32,.24),new Lr({color:s.accent,transparent:!0,opacity:.64}));e.position.set(-.12,-.08,.18),p.add(e)}!c.includes(`bow`)&&!c.includes(`crossbow`)&&!c.includes(`staff`)&&(p.rotation.z=.22),e.add(p),f||$(e,`left-hand-grip`,[.24,.2,.24],[-.88,.08,.3],this.photoSkin??u.color,.02),this.makeArtifact(l,u),this.makePartner(),this.makeSparkles(a.accent,l.accent),this.onChange?.()}makeArtifact(e,t){let n=new Cn;if(n.position.set(1.42,-.28,-.02),n.scale.setScalar(.72),e.name.includes(`Quiver`)){$(n,`quiver-case`,[.34,.95,.28],[0,.25,0],e.color,.08).rotation.z=-.18,$(n,`quiver-band-top`,[.42,.08,.32],[0,.58,.02],e.accent,.14).rotation.z=-.18,$(n,`quiver-band-low`,[.42,.08,.32],[0,.12,.02],Q(e.accent,.72),.1).rotation.z=-.18;for(let t=0;t<5;t++){let r=$(n,`firework-rocket`,[.06,.76,.06],[-.14+t*.07,.88+t%2*.05,.08],e.accent,.12);r.rotation.z=-.18,$(n,`rocket-cap`,[.11,.08,.08],[-.14+t*.07,1.28+t%2*.05,.08],Nl(e.accent,.2),.14).rotation.z=-.18}$(n,`spark-fuse`,[.22,.08,.08],[.16,1.25,.12],Nl(e.accent,.18),.1)}else if(e.name.includes(`Totem`))$(n,`totem-body`,[.36,.62,.2],[0,.18,0],e.color,.08),$(n,`totem-face`,[.24,.2,.05],[0,.32,.12],e.accent,.12),$(n,`totem-arms`,[.62,.12,.12],[0,.16,.08],Q(e.color,.72),.06);else if(e.name.includes(`Boots`))$(this.gear,`boot-glow-l`,[.56,.08,.56],[-.3,-1.9,.04],e.accent,.18),$(this.gear,`boot-glow-r`,[.56,.08,.56],[.3,-1.9,.04],e.accent,.18),$(n,`boot-charm`,[.2,.28,.1],[0,.2,0],e.color,.08);else{$(n,`amulet-chain`,[.52,.06,.05],[0,.52,0],14201450,.24).rotation.z=-.4,$(n,`amulet-chain-b`,[.52,.06,.05],[0,.52,0],14201450,.24).rotation.z=.4,Ml(n,e.accent,[0,.22,.08],1);let t=new Ua(e.accent,1.6,3);t.position.set(0,.24,.24),n.add(t)}this.gear.add(n)}makeAlly(e,t,n,r){let i=new Cn;if(i.scale.setScalar(.56),i.position.set(t,-.82,-.18),$(i,`${e}-cloak`,[.82,1.16,.08],[0,-.02,-.28],Q(n,.55),.02),$(i,`${e}-body`,[.76,1.05,.44],[0,0,0],n,.08),$(i,`${e}-head`,[.56,.54,.56],[0,.82,0],10710866,.02),$(i,`${e}-hood`,[.68,.3,.68],[0,1.1,0],r,.06),$(i,`${e}-pauldron-l`,[.28,.22,.42],[-.5,.38,0],r,.12),$(i,`${e}-pauldron-r`,[.28,.22,.42],[.5,.38,0],r,.12),e===`rogue`){let e=new Cn;Il(e,`rogue-dagger`,0,-.12,.18,3811874,14144198,.48),e.position.set(.48,-.05,.02),e.rotation.z=-.55,i.add(e)}else $(i,`mage-staff`,[.08,1.42,.08],[-.52,.22,.22],5980456,.08),$(i,`mage-staff-ring`,[.36,.08,.08],[-.52,.9,.22],r,.16),Ml(i,r,[-.52,1.05,.22],.72);return this.root.add(i),i}makeAllies(){this.allyRogue=this.makeAlly(`rogue`,-1.75,2433848,7297675),this.allyRogue.scale.setScalar(.58),this.allyRogue.position.z=-.38,this.allyMage=this.makeAlly(`mage`,1.75,2834512,8245174),this.allyMage.scale.setScalar(.58),this.allyMage.position.z=-.42}makePartner(){let e=Ol.partner[this.state.partner],t=this.partnerGroup;t.position.set(-3.05,-1.16,.38),t.scale.setScalar(1.15);let n=Q(e.accent,.8);if(e.name.includes(`Wolf`)){$(t,`wolf-body`,[.92,.42,.46],[0,.02,0],e.color,.08),$(t,`wolf-chest`,[.32,.48,.5],[.42,.12,0],Nl(e.color,.12),.08),$(t,`wolf-head`,[.46,.42,.42],[.82,.24,0],e.color,.08),$(t,`wolf-ear-a`,[.14,.24,.1],[.9,.58,.16],e.accent,.06),$(t,`wolf-ear-b`,[.14,.24,.1],[.9,.58,-.16],e.accent,.06),$(t,`wolf-armor`,[.66,.18,.54],[0,.34,0],n,.16),$(t,`wolf-helm`,[.38,.2,.3],[.78,.38,0],n,.16),$(t,`wolf-helm-spike`,[.09,.28,.09],[.88,.62,0],e.accent,.12),$(t,`wolf-strap`,[.08,.58,.54],[.1,.22,0],e.accent,.12);for(let n of[-.28,.28])$(t,`wolf-leg-front`,[.14,.44,.14],[n+.32,-.22,.16],Q(e.color,.72),.05),$(t,`wolf-leg-back`,[.14,.44,.14],[n-.32,-.22,-.16],Q(e.color,.72),.05);$(t,`wolf-snout`,[.28,.18,.24],[1.1,.2,0],Nl(e.color,.16),.06),$(t,`wolf-tail`,[.48,.14,.14],[-.62,.18,0],e.color,.05).rotation.z=.35}else if(e.name.includes(`Drake`)){$(t,`drake-body`,[.82,.42,.46],[0,.06,0],e.color,.08),$(t,`drake-neck`,[.28,.38,.28],[.52,.28,0],e.color,.08).rotation.z=-.25,$(t,`drake-head`,[.46,.34,.38],[.82,.44,0],e.color,.08),$(t,`drake-wing-l`,[.12,.72,.72],[-.18,.36,-.36],e.accent,.1).rotation.x=.5,$(t,`drake-wing-r`,[.12,.72,.72],[-.18,.36,.36],e.accent,.1).rotation.x=-.5,$(t,`drake-tail`,[.68,.12,.12],[-.62,.12,0],e.color,.05).rotation.z=-.25;for(let n of[-.24,.26])$(t,`drake-leg`,[.16,.34,.16],[n,-.18,.18],Q(e.color,.72),.05)}else e.name.includes(`Golem`)?($(t,`golem-torso`,[.72,.72,.52],[0,.22,0],e.color,.12),$(t,`golem-head`,[.52,.42,.42],[.05,.84,0],Nl(e.color,.08),.12),$(t,`golem-arm-l`,[.24,.62,.28],[-.52,.22,0],Q(e.color,.8),.12),$(t,`golem-arm-r`,[.24,.62,.28],[.52,.22,0],Q(e.color,.8),.12),Pl(t,e.accent,.05,.24,.28),$(t,`golem-plate`,[.48,.12,.08],[0,.48,.3],e.accent,.14)):($(t,`bat-body`,[.38,.48,.28],[0,.28,0],e.color,.05),$(t,`bat-head`,[.34,.3,.3],[.3,.48,0],e.color,.05),$(t,`bat-wing-l`,[.12,.72,.82],[-.22,.3,-.42],e.accent,.06).rotation.x=.36,$(t,`bat-wing-r`,[.12,.72,.82],[-.22,.3,.42],e.accent,.06).rotation.x=-.36,$(t,`bat-ears`,[.16,.22,.42],[.34,.76,0],e.accent,.05))}makeSparkles(e,t){for(let n=0;n<18;n++){let r=new Y(new Xi(.035+Math.random()*.045),Al(n%2?e:t,.2,.25)),i=n/18*Math.PI*2;r.position.set(Math.cos(i)*(1.4+Math.random()*1.2),-.7+Math.random()*2.8,Math.sin(i)*(1.4+Math.random()*1.2)),r.userData.float=Math.random()*Math.PI*2,this.sparkleGroup.add(r)}}makeDungeonSet(){let e=new Cn,t=Al(3814187,.82,.02);for(let n=0;n<9;n++){let r=new Y(new yi(.72,.28,.22),t);r.position.set(-3+n%5*1.45+Math.floor(n/5)*.35,-1.07+Math.floor(n/5)*.3,-2.45),r.castShadow=!0,r.receiveShadow=!0,e.add(r)}let n=jl(`left-pillar`,[.42,2.55,.48],[-2.72,-.18,-1.95],4208687,.01),r=jl(`right-pillar`,[.42,2.55,.48],[2.72,-.18,-1.95],4208687,.01),i=jl(`banner-left`,[.42,1.15,.04],[-2.72,.55,-1.68],7024418,.02),a=jl(`banner-right`,[.42,1.15,.04],[2.72,.55,-1.68],2440278,.02);e.add(n,r,i,a),this.root.add(e);let o=new Ua(16747050,2.8,5);o.position.set(-2.55,.92,-1.35);let s=o.clone();s.position.set(2.55,.92,-1.35),this.root.add(o,s)}makePortalSet(){let e=new Cn,t=new Lr({color:16742946,transparent:!0,opacity:.42,depthWrite:!1}),n=new Lr({color:16757575,transparent:!0,opacity:.34,depthWrite:!1}),r=new Y(new Zi(2.65,3.55),t);r.position.set(0,.35,-2.16);let i=new Y(new Zi(1.65,2.65),n);i.position.set(0,.3,-2.12),e.add(r,i);let a=Al(16742946,.35,.02),o=Al(16760914,.32,.02);for(let t=0;t<11;t++){let n=1.1+t*.12,r=new Y(new yi(.22,n,.12),t%2?a:o);r.position.set(-.98-t*.07,-.75+n/2,-2-t*.006);let i=r.clone();i.position.x*=-1,e.add(r,i)}for(let t=0;t<9;t++){let n=new Y(new yi(.34,.18,.1),t%2?a:o);n.position.set(-1.35+t*.34,2.08+Math.sin(t)*.06,-2.02),e.add(n)}let s=new Ua(16742946,13,11);s.position.set(0,.38,-1.35);let c=new Ua(16727322,4.5,6);c.position.set(0,-1.05,.4),this.root.add(s,c,e)}applyPhotoColors(e){let t=new Image,n=URL.createObjectURL(e);t.onload=()=>{let e=document.createElement(`canvas`);e.width=48,e.height=48;let r=e.getContext(`2d`);r.drawImage(t,0,0,48,48);let i=r.getImageData(0,0,48,48).data,a=new J,o=new J,s=0,c=0;for(let e=0;e<i.length;e+=4){let t=i[e],n=i[e+1],r=i[e+2];Math.max(t,n,r)-Math.min(t,n,r)>18&&t>n*.92&&n>r*.72&&t>75&&(a.r+=t/255,a.g+=n/255,a.b+=r/255,s++),(t+n+r<260||t>80&&n>45&&r<45)&&(o.r+=t/255,o.g+=n/255,o.b+=r/255,c++)}s&&(this.photoSkin=a.multiplyScalar(1/s).getHex()),c&&(this.photoHair=o.multiplyScalar(1/c).lerp(new J(2823951),.22).getHex()),URL.revokeObjectURL(n),this.refreshGear()},t.src=n}randomize(){return Object.keys(Ol).forEach(e=>this.state[e]=Math.floor(Math.random()*Ol[e].length)),this.refreshGear(),[`Leo Ironleaf`,`Thorn of Oakvale`,`Garrick Wolfguard`,`Mira Emberhand`,`Rowan Deepdelver`,`Sir Thunderbrook`][Math.floor(Math.random()*6)]}cycleSlot(e,t){this.state[e]=(this.state[e]+t+Ol[e].length)%Ol[e].length,this.refreshGear()}setSlot(e,t){let n=Ol[e].length;this.state[e]=(t%n+n)%n,this.refreshGear()}onPointerDown=e=>{this.dragging=!0,this.lastX=e.clientX,this.inputEl?.setPointerCapture(e.pointerId)};onPointerMove=e=>{this.dragging&&(this.targetRot+=(e.clientX-this.lastX)*.012,this.lastX=e.clientX)};onPointerUp=()=>{this.dragging=!1};onWheel=e=>{e.preventDefault(),this.autoZoom=!1,this.zoom=Tt.clamp(this.zoom+e.deltaY*.006,4.7,9.8)};attachInput(e){this.inputEl=e,e.addEventListener(`pointerdown`,this.onPointerDown),e.addEventListener(`pointermove`,this.onPointerMove),e.addEventListener(`pointerup`,this.onPointerUp),e.addEventListener(`wheel`,this.onWheel,{passive:!1})}detachInput(){let e=this.inputEl;e&&(e.removeEventListener(`pointerdown`,this.onPointerDown),e.removeEventListener(`pointermove`,this.onPointerMove),e.removeEventListener(`pointerup`,this.onPointerUp),e.removeEventListener(`wheel`,this.onWheel),this.dragging=!1,this.inputEl=null)}reattachHero(){this.root.add(this.hero),this.hero.scale.setScalar(.92),this.hero.position.set(0,0,0),this.hero.rotation.set(0,this.targetRot,0)}forgeTick(e){this.elapsedMs+=e*1e3;let t=this.elapsedMs;this.hero.rotation.y=Tt.lerp(this.hero.rotation.y,this.targetRot,.085),this.camera.position.z=Tt.lerp(this.camera.position.z,this.zoom,.08),this.camera.lookAt(0,.05,0),this.hero.position.y=Math.sin(t*.004)*.055,this.partnerGroup.position.y=-.84+Math.sin(t*.005+1.3)*.05,this.rightArm.rotation.z=-.54+Math.sin(t*.006)*.06,this.leftArm.rotation.z=.12+Math.sin(t*.006+Math.PI)*.05,this.allyRogue.rotation.y=-.28+Math.sin(t*.002)*.06,this.allyMage.rotation.y=.28+Math.sin(t*.002+1.4)*.06,this.sparkleGroup.children.forEach((e,n)=>{e.rotation.y+=.02+n*5e-4,e.position.y+=Math.sin(t*.002+e.userData.float)*.0018})}resize(e,t){if(this.camera.aspect=e/t,this.camera.updateProjectionMatrix(),this.autoZoom){let n=Math.max(0,620-t)*.0045,r=e/t<1.05?.55:0;this.zoom=Tt.clamp(8.1+n+r,7.25,9.55)}}},Rl=.25,zl=class{held=new Set;attached=!1;hadGamepad=!1;onKeyDown=e=>{let t=e.key.toLowerCase();(Bl.has(t)||t===` `||t===`spacebar`)&&(this.held.add(t===`spacebar`?` `:t),t===` `&&e.preventDefault())};onKeyUp=e=>{let t=e.key.toLowerCase();this.held.delete(t===`spacebar`?` `:t)};onGamepadConnected=()=>{this.hadGamepad=!0};onGamepadDisconnected=()=>{this.hadGamepad=!1};attach(){this.attached||=(window.addEventListener(`keydown`,this.onKeyDown),window.addEventListener(`keyup`,this.onKeyUp),window.addEventListener(`gamepadconnected`,this.onGamepadConnected),window.addEventListener(`gamepaddisconnected`,this.onGamepadDisconnected),!0)}detach(){this.attached&&=(window.removeEventListener(`keydown`,this.onKeyDown),window.removeEventListener(`keyup`,this.onKeyUp),window.removeEventListener(`gamepadconnected`,this.onGamepadConnected),window.removeEventListener(`gamepaddisconnected`,this.onGamepadDisconnected),this.held.clear(),!1)}hasKeyboardInput(){return this.held.size>0}keyboardCommand(){let e=0,t=0;return(this.held.has(`a`)||this.held.has(`arrowleft`))&&--e,(this.held.has(`d`)||this.held.has(`arrowright`))&&(e+=1),(this.held.has(`w`)||this.held.has(`arrowup`))&&--t,(this.held.has(`s`)||this.held.has(`arrowdown`))&&(t+=1),{move:{x:e,z:t},dodge:this.held.has(` `)}}gamepadCommand(){let e=navigator.getGamepads?.bind(navigator);if(!e)return null;let t;try{t=e()}catch{return null}for(let e of t){if(!e||!e.connected)continue;let t=e.axes[0]??0,n=e.axes[1]??0,r=Math.hypot(t,n),i=e.buttons.some((e,t)=>Vl.has(t)&&e.pressed);if(!(r<Rl&&!i))return{move:r<Rl?{x:0,z:0}:{x:t,z:n},dodge:i}}return null}},Bl=new Set([`w`,`a`,`s`,`d`,`arrowup`,`arrowdown`,`arrowleft`,`arrowright`]),Vl=new Set([0,1]),Hl=class{stepSeconds;maxFrameSeconds;acc=0;constructor(e,t=.25){this.stepSeconds=e,this.maxFrameSeconds=t}advance(e){e<0&&(e=0),e>this.maxFrameSeconds&&(e=this.maxFrameSeconds),this.acc+=e;let t=0;for(;this.acc>=this.stepSeconds;)this.acc-=this.stepSeconds,t++;return t}get alpha(){return this.acc/this.stepSeconds}reset(){this.acc=0}},Ul=1/60,Wl={maxSpeed:6,accel:80,decel:120,facingSnapDeg:45,snapHysteresisDeg:12};function Gl(e){let t=eu(5+e*.15,5,9),n=eu(70+e*1.2,70,110);return{...Wl,maxSpeed:t,accel:n}}var Kl={startupTicks:3,activeTicks:12,recoveryTicks:15,cooldownTicks:120,bufferTicks:6,cancelWindowTicks:8,rollSpeed:9,heroHalfExtent:.45},ql=(e=0,t=0)=>({x:e,z:t}),Jl=(e,t)=>({x:e.x+t.x,z:e.z+t.z}),Yl=(e,t)=>({x:e.x-t.x,z:e.z-t.z}),Xl=(e,t)=>({x:e.x*t,z:e.z*t}),Zl=e=>Math.hypot(e.x,e.z),Ql=(e,t)=>Math.hypot(e.x-t.x,e.z-t.z);function $l(e,t){let n=Zl(e);return n>t&&n>1e-9?Xl(e,t/n):{x:e.x,z:e.z}}var eu=(e,t,n)=>e<t?t:e>n?n:e,tu=e=>Math.atan2(Math.sin(e),Math.cos(e));function nu(e=ql(0,0),t=0){return{position:{...e},velocity:ql(0,0),facing:t,speed:0,phase:`grounded`,phaseTick:0,cooldownTick:0,bufferTick:0,rollDir:ql(0,0),invulnerable:!1,dodgeWasDown:!1}}function ru(e=1){return{hero:nu(),tick:0,seed:e,lastEvent:null,colliders:[],bounds:{minX:-1/0,maxX:1/0,minZ:-1/0,maxZ:1/0}}}var iu=class{container;scene=new Mn;renderer;forge=new Ll;mode=`forge`;accumulator=new Hl(Ul);lastTime=0;running=!1;fpsEma=60;tickCount=0;lastEvent=null;inputSource=new zl;apiInput={move:{x:0,z:0},dodge:!1};currentInput={move:{x:0,z:0},dodge:!1};pendingSeed=1;arenaWorld=null;constructor(e){this.container=e,this.renderer=new Dl({antialias:!0,alpha:!0,preserveDrawingBuffer:!0}),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,2)),e.appendChild(this.renderer.domElement),this.scene.add(this.forge.root),this.applyForgeProfile(),this.forge.attachInput(e),window.addEventListener(`resize`,this.onResize),window.visualViewport?.addEventListener(`resize`,this.onResize),window.visualViewport?.addEventListener(`scroll`,this.onResize),this.renderer.domElement.addEventListener(`webglcontextlost`,e=>e.preventDefault()),window.addEventListener(`pagehide`,this.dispose)}dispose=()=>{this.running=!1,this.renderer.dispose(),this.renderer.forceContextLoss()};applyForgeProfile(){this.scene.fog=this.forge.fog,this.renderer.shadowMap.enabled=!0}applyArenaProfile(){this.scene.fog=null,this.renderer.shadowMap.enabled=!1}get currentMode(){return this.mode}get fps(){return this.fpsEma}get ticks(){return this.tickCount}arenaCamera=null;arenaResize=null;get activeCamera(){return this.mode===`arena`&&this.arenaCamera?this.arenaCamera:this.forge.camera}start(){this.running=!0,this.resize(),requestAnimationFrame(this.frame)}stop(){this.running=!1}frame=e=>{if(!this.running)return;requestAnimationFrame(this.frame),this.lastTime===0&&(this.lastTime=e);let t=(e-this.lastTime)/1e3;this.lastTime=e;try{this.sampleInput();let e=this.accumulator.advance(t);for(let t=0;t<e;t++)this.update(Ul),this.tickCount++;t>0&&(this.fpsEma=this.fpsEma*.9+1/t*.1),this.render(this.accumulator.alpha)}catch(e){console.error(`Frame error (loop continues):`,e)}};sampleInput(){let e=this.inputSource.gamepadCommand();e?this.currentInput=e:this.inputSource.hasKeyboardInput()?this.currentInput=this.inputSource.keyboardCommand():this.currentInput=this.apiInput}manualStep=!1;update(e){this.mode===`forge`?this.forge.forgeTick(e):this.manualStep||this.arenaTick(e)}setManualStep(e){this.manualStep=e}stepArena(e,t){if(this.mode!==`arena`||!this.arenaStepper)return[];if(!this.manualStep)return console.warn(`window.__game.step() requires setManualStep(true) first; ignoring to avoid a double-step.`),[];let n=t?{move:{x:t.move?.x??0,z:t.move?.z??0},dodge:t.dodge??!1}:this.currentInput,r=[];for(let t=0;t<e;t++)this.arenaStepper(Ul,n),this.tickCount++,r.push(this.getState());return r}arenaStepper=null;setArenaStepper(e){this.arenaStepper=e}arenaTick(e){this.arenaStepper?.(e,this.currentInput)}setApiInput(e){this.apiInput={move:e.move?{x:e.move.x??0,z:e.move.z??0}:this.apiInput.move,dodge:e.dodge??!1}}get input(){return this.currentInput}setLoadout(e,t){this.forge.setSlot(e,t)}randomizeLoadout(){return{name:this.forge.randomize()}}setSeed(e){this.pendingSeed=e>>>0,this.arenaWorld&&(this.arenaWorld.seed=this.pendingSeed),this.lastEvent=`set-seed:${this.pendingSeed}`}get seed(){return this.arenaWorld?.seed??this.pendingSeed}onEnterArena=null;onReturnToForge=null;juiceProvider=null;readabilityProvider=null;readability(){return this.readabilityProvider?.()??null}enterArena(){this.mode!==`arena`&&(this.mode=`arena`,this.forge.detachInput(),this.inputSource.attach(),this.forge.root.visible=!1,this.applyArenaProfile(),document.body?.classList.add(`mode-arena`),this.apiInput={move:{x:0,z:0},dodge:!1},this.onEnterArena?.(),this.lastEvent=`enter-arena`,this.resize())}returnToForge(){this.mode!==`forge`&&(this.mode=`forge`,this.inputSource.detach(),this.onReturnToForge?.(),this.forge.reattachHero(),this.forge.root.visible=!0,this.applyForgeProfile(),this.forge.attachInput(this.container),document.body?.classList.remove(`mode-arena`),this.lastEvent=`return-forge`,this.resize())}loadArena(e){this.setSeed(e),this.mode===`arena`&&(this.onEnterArena?.(),this.lastEvent=`load-arena:${e>>>0}`)}getState(){let e=this.arenaWorld?.hero??null,t=this.activeCamera;return t.updateMatrixWorld(),{mode:this.mode,tick:this.tickCount,fps:Math.round(this.fpsEma),seed:this.seed,lastEvent:this.arenaWorld?.lastEvent??this.lastEvent,camera:{quaternion:[t.quaternion.x,t.quaternion.y,t.quaternion.z,t.quaternion.w],matrix:Array.from(t.matrixWorld.elements)},juice:this.juiceProvider?.()??null,bounds:this.arenaWorld?{...this.arenaWorld.bounds}:null,forge:{...this.forge.state},hero:e?{position:{x:e.position.x,z:e.position.z},velocity:{x:e.velocity.x,z:e.velocity.z},facing:e.facing,speed:e.speed,phase:e.phase,invulnerable:e.invulnerable,cooldownTick:e.cooldownTick}:null}}render(e){this.renderer.render(this.scene,this.activeCamera)}onResize=()=>this.resize();resize(){this.updateViewportVars();let e=this.container.getBoundingClientRect();!e.width||!e.height||(this.renderer.setSize(e.width,e.height),this.mode===`forge`?this.forge.resize(e.width,e.height):this.arenaResize?.(e.width,e.height))}updateViewportVars(){let e=window.visualViewport,t=e?.height??window.innerHeight,n=e?.width??window.innerWidth;document.documentElement.style.setProperty(`--app-height`,`${t}px`),document.documentElement.style.setProperty(`--app-width`,`${n}px`)}},au=Math.PI/180,ou=.08;function su(e){return{x:Math.sin(e),z:Math.cos(e)}}function cu(e,t,n,r){let i=n*au,a=i/2,o=r/2*au;return Math.abs(tu(e-t))>a+o?tu(Math.round(e/i)*i):t}function lu(e,t,n,r){let i=$l(t.move,1),a=Zl(i),o=a>ou,s=e.facing,c={x:0,z:0};o&&(s=cu(Math.atan2(i.x,i.z),e.facing,n.facingSnapDeg,n.snapHysteresisDeg),c=Xl(su(s),a*n.maxSpeed));let l=Yl(c,e.velocity),u=Zl(l),d=(o?n.accel:n.decel)*r,f=u<=d||u<1e-9?c:Jl(e.velocity,Xl(l,d/u)),p=Zl(f),m=Jl(e.position,Xl(f,r));return{...e,position:m,velocity:f,facing:s,speed:p}}var uu=.08;function du(e){return{x:Math.sin(e),z:Math.cos(e)}}function fu(e,t,n,r){let{phase:i,phaseTick:a,cooldownTick:o,bufferTick:s,rollDir:c,facing:l}=e,u=e.velocity;o>0&&--o,s>0&&--s,t.dodge&&!e.dodgeWasDown&&(s=n.bufferTicks);let d=Zl(t.move)>uu,f=()=>{i=`startup`,a=0,s=0,c=du(l)};switch(a+=1,i){case`grounded`:s>0&&o===0&&f();break;case`startup`:a>=n.startupTicks&&(i=`active`,a=0);break;case`active`:a>=n.activeTicks&&(i=`recovery`,a=0);break;case`recovery`:a>=n.recoveryTicks?(i=`grounded`,a=0,o=n.cooldownTicks):a>=n.recoveryTicks-n.cancelWindowTicks&&(s>0&&o===0?(f(),o=n.cooldownTicks):d&&(i=`grounded`,a=0,o=n.cooldownTicks));break}(i===`startup`||i===`active`)&&(l=Math.atan2(c.x,c.z)),i===`active`&&(u=Xl(c,n.rollSpeed));let p=i===`active`;return{...e,phase:i,phaseTick:a,cooldownTick:o,bufferTick:s,rollDir:c,facing:l,velocity:u,speed:Zl(u),invulnerable:p,dodgeWasDown:t.dodge}}function pu(e,t){return{minX:e.minX-t,maxX:e.maxX+t,minZ:e.minZ-t,maxZ:e.maxZ+t}}function mu(e,t,n){let r=e+t,i=!1;if(t>0)for(let[t,a]of n)e<=t+1e-9&&r>t&&e<a&&t<r&&(r=t,i=!0);else if(t<0)for(let[t,a]of n)e>=a-1e-9&&r<a&&e>t&&a>r&&(r=a,i=!0);return{end:r,hit:i}}function hu(e,t,n,r){let i=n.map(e=>pu(e,r)),a=[];for(let t of i)e.z>t.minZ&&e.z<t.maxZ&&a.push([t.minX,t.maxX]);let o=mu(e.x,t.x,a),s=o.end,c=[];for(let e of i)s>e.minX&&s<e.maxX&&c.push([e.minZ,e.maxZ]);let l=mu(e.z,t.z,c);return{position:{x:s,z:l.end},hitX:o.hit,hitZ:l.hit}}function gu(e,t,n,r=Wl,i=Kl){let a=e.hero.phase,o=vu(_u(e.hero),t,n,r,i,e),s=e.lastEvent;return o.hero.phase!==a&&(a===`grounded`||a===`recovery`)&&o.hero.phase===`startup`?s=`dodge:start`:(o.hitX||o.hitZ)&&(s=(o.hitX||o.hitZ)&&!(o.hitX&&o.hitZ)&&o.hero.speed>.05?`wall-slide`:`collide`),{...e,hero:o.hero,colliders:e.colliders,bounds:{...e.bounds},tick:e.tick+1,lastEvent:s}}function _u(e){return{...e,position:{...e.position},velocity:{...e.velocity},rollDir:{...e.rollDir}}}function vu(e,t,n,r,i,a){let o=e.position,s=fu(lu(e,t,r,n),t,i,n),c=hu(o,Xl(s.velocity,n),a.colliders,i.heroHalfExtent),l=c.hitX,u=c.hitZ,d={x:l?0:s.velocity.x,z:u?0:s.velocity.z};return{hero:{...s,position:c.position,velocity:d,speed:Zl(d)},hitX:l,hitZ:u}}function yu(e,t,n,r,i){let a=e-n,o=t+r*a,s=Math.exp(-r*i);return[n+(a+o*i)*s,(o-r*(a+o*i))*s]}function bu(e,t,n,r){let[i,a]=yu(e.pos.x,e.vel.x,t.x,n,r),[o,s]=yu(e.pos.z,e.vel.z,t.z,n,r);return{pos:{x:i,z:o},vel:{x:a,z:s}}}function xu(e){if(e.length===0)return{center:ql(0,0),diagonal:0};let t=1/0,n=-1/0,r=1/0,i=-1/0;for(let a of e)a.x<t&&(t=a.x),a.x>n&&(n=a.x),a.z<r&&(r=a.z),a.z>i&&(i=a.z);return{center:{x:(t+n)/2,z:(r+i)/2},diagonal:Math.hypot(n-t,i-r)}}function Su(e,t=1/64){return Math.round(e/t)*t}function Cu(e){let t=e>>>0,n=t,r=()=>{t|=0,t=t+1831565813|0;let e=Math.imul(t^t>>>15,1|t);return e=e+Math.imul(e^e>>>7,61|e)^e,((e^e>>>14)>>>0)/4294967296};return{next:r,int:e=>Math.floor(r()*e),range:(e,t)=>e+r()*(t-e),reseed(e){n=e>>>0,t=n},get seed(){return n}}}var wu=24,Tu=24;function Eu(e){return e!==0}function Du(e,t,n){let r=Array.from({length:Tu},()=>Array(wu).fill(!1)),i=[[n,t]];r[n][t]=!0;let a=0;for(;i.length;){let[t,n]=i.pop();a++;let o=[[t-1,n],[t+1,n],[t,n-1],[t,n+1]];for(let[t,n]of o)t<0||t>=Tu||n<0||n>=wu||r[t][n]||e[t][n]!==0||(r[t][n]=!0,i.push([t,n]))}return a}function Ou(e){let t=0;for(let n=0;n<Tu;n++)for(let r=0;r<wu;r++)e[n][r]===0&&t++;return t}function ku(){let e=Array.from({length:Tu},()=>Array(wu).fill(0));for(let t=0;t<wu;t++)e[0][t]=1,e[Tu-1][t]=1;for(let t=0;t<Tu;t++)e[t][0]=1,e[t][wu-1]=1;return e}function Au(e){let t=Math.floor(wu/2),n=Math.floor(Tu/2),r=Cu(e>>>0),i=(e,r)=>Math.abs(e-t)<=1&&Math.abs(r-n)<=1;for(let e=0;e<24;e++){let e=ku(),a=6+r.int(7);for(let t=0;t<a;t++){let t=2+r.int(wu-4),n=2+r.int(Tu-4),a=1+r.int(3),o=r.next()<.5;for(let r=0;r<a;r++){let a=o?t+r:t,s=o?n:n+r;a<=0||a>=wu-1||s<=0||s>=Tu-1||i(a,s)||(e[s][a]=2)}}for(let r=-1;r<=1;r++)for(let i=-1;i<=1;i++)e[n+r][t+i]=0;if(Du(e,t,n)===Ou(e))return{width:wu,height:Tu,tileSize:1,cells:e,spawnCol:t,spawnRow:n}}return{width:wu,height:Tu,tileSize:1,cells:ku(),spawnCol:t,spawnRow:n}}function ju(e,t,n,r,i){let a=e.width/2,o=e.height/2;return{minX:t-a,maxX:n+1-a,minZ:r-o,maxZ:i+1-o}}function Mu(e){let{cells:t,width:n,height:r}=e,i=Array.from({length:r},()=>Array(n).fill(!1)),a=[];for(let o=0;o<r;o++)for(let s=0;s<n;s++){if(!Eu(t[o][s])||i[o][s])continue;let c=s;for(;c+1<n&&Eu(t[o][c+1])&&!i[o][c+1];)c++;let l=o,u=!0;for(;u&&l+1<r;){for(let e=s;e<=c;e++)if(!Eu(t[l+1][e])||i[l+1][e]){u=!1;break}u&&l++}for(let e=o;e<=l;e++)for(let t=s;t<=c;t++)i[e][t]=!0;a.push(ju(e,s,c,o,l))}return a}function Nu(e){return{minX:-e.width/2,maxX:e.width/2,minZ:-e.height/2,maxZ:e.height/2}}function Pu(e){return{x:e.spawnCol-e.width/2+.5,z:e.spawnRow-e.height/2+.5}}var Fu=8,Iu=.05,Lu=.08,Ru=.25,zu=12,Bu=6,Vu=class{hero;root;cloak=null;dust=[];prevPhase=`grounded`;prevFacing=0;prevSpeed=0;antTimer=0;antSign=1;squashTimer=0;cloakOffset=0;cloakVel=0;markers={anticipation:0,followThrough:0,squash:0,dust:0};constructor(e,t){this.hero=e,this.root=t,this.cloak=e.getObjectByName(`cloak`)??null;let n=new yi(.14,.14,.14);for(let e=0;e<zu;e++){let e=new Y(n,new Lr({color:12101768,transparent:!0,opacity:0}));e.visible=!1,t.add(e),this.dust.push({mesh:e,age:-1,vx:0,vy:0,vz:0})}}reset(){this.prevPhase=`grounded`,this.antTimer=0,this.squashTimer=0,this.cloakOffset=0,this.cloakVel=0;for(let e of this.dust)e.age=-1,e.mesh.visible=!1;this.hero.scale.setScalar(1),this.cloak&&(this.cloak.rotation.z=0)}getMarkers(){return this.markers}update(e,t){t.phase===`startup`&&this.prevPhase!==`startup`&&(this.antTimer=Iu,this.antSign=t.rollDir.x>=0?-1:1),t.phase===`recovery`&&this.prevPhase===`active`&&(this.squashTimer=Lu,this.spawnDust(t)),this.prevSpeed>3&&t.speed<.5&&t.phase===`grounded`&&this.spawnDust(t),this.prevPhase=t.phase;let n=0;if(this.antTimer>0){this.antTimer=Math.max(0,this.antTimer-e);let t=this.antTimer/Iu;n=this.antSign*(Fu*Math.PI)/180*t}let r=tu(t.facing-this.prevFacing)/Math.max(e,1e-4);this.prevFacing=t.facing;let i=Hu(-r*.04,.5),a=16*.6*-2*this.cloakVel-256*(this.cloakOffset-i);this.cloakVel+=a*e,this.cloakOffset+=this.cloakVel*e,this.cloak&&(this.cloak.rotation.z=this.cloakOffset);let o=0;this.squashTimer>0&&(this.squashTimer=Math.max(0,this.squashTimer-e),o=this.squashTimer/Lu),this.hero.scale.set(1+.1*o,1-.15*o,1+.1*o),this.hero.rotation.y+=n;let s=0;for(let t of this.dust){if(t.age<0)continue;if(t.age+=e,t.age>=Ru){t.age=-1,t.mesh.visible=!1;continue}s++;let n=t.age/Ru;t.mesh.position.x+=t.vx*e,t.mesh.position.y+=t.vy*e,t.mesh.position.z+=t.vz*e,t.mesh.scale.setScalar(1-n),t.mesh.material.opacity=.7*(1-n)}this.prevSpeed=t.speed,this.markers={anticipation:n,followThrough:this.cloakOffset,squash:o,dust:s}}spawnDust(e){let t=0;for(let n of this.dust){if(t>=Bu)break;if(n.age>=0)continue;let r=t/Bu*Math.PI*2;n.age=0,n.vx=Math.cos(r)*1.2,n.vy=1.4,n.vz=Math.sin(r)*1.2,n.mesh.position.set(e.position.x+Math.cos(r)*.2,.1,e.position.z+Math.sin(r)*.2),n.mesh.scale.setScalar(1),n.mesh.material.opacity=.7,n.mesh.visible=!0,t++}}};function Hu(e,t){return e>t?t:e<-t?-t:e}function Uu(e){let t=e/255;return t<=.03928?t/12.92:((t+.055)/1.055)**2.4}function Wu(e){let t=e>>16&255,n=e>>8&255,r=e&255;return .2126*Uu(t)+.7152*Uu(n)+.0722*Uu(r)}function Gu(e,t){let n=Wu(e),r=Wu(t),i=Math.max(n,r),a=Math.min(n,r);return(i+.05)/(a+.05)}function Ku(e,t,n){return Gu(e,t)<n}var qu=1.6,Ju=1.9,Yu=17,Xu=28,Zu=40,Qu=9,$u=2.5,ed=.4,td=2.5,nd=7037784,rd=4341047,id=9071172,ad=class{root=new Cn;camera;world=ru(1);movement=Gl(1);dodge={...Kl};hero=null;aspect=1;frustumSize=Yu;walls=null;juice=null;rim;shadowDisc;rimApplied=!1;heroLuminance=0;camOffset=new G().setFromSphericalCoords(Zu,Math.PI/3,Math.PI/4);camSpring={pos:{x:0,z:0},vel:{x:0,z:0}};lastGoal={x:0,z:0};framingTargets=[{x:0,z:0}];constructor(){this.camera=new Wa,this.camera.near=.1,this.camera.far=500,this.updateFrustum(),this.placeCamera(0,0);let e=new Y(new Zi(80,80),new la({color:nd,roughness:.96,metalness:0}));e.rotation.x=-Math.PI/2,e.position.y=0,this.root.add(e),this.root.add(new ka(15919832,5591114,1.35));let t=new Ka(16777215,1.9);t.position.set(6,12,5),this.root.add(t),this.rim=new Ka(13623551,.6),this.rim.position.set(-6,8,-6),this.root.add(this.rim),this.shadowDisc=new Y(new bi(.62,24),new Lr({color:0,transparent:!0,opacity:.32,depthWrite:!1})),this.shadowDisc.rotation.x=-Math.PI/2,this.shadowDisc.position.y=.02,this.root.add(this.shadowDisc)}receiveHero(e){this.hero=e,this.root.add(e),e.scale.setScalar(1),e.position.set(this.world.hero.position.x,Ju,this.world.hero.position.z),e.rotation.set(0,this.world.hero.facing,0),this.juice||=new Vu(e,this.root),this.juice.reset()}juiceMarkers(){return this.juice?.getMarkers()??null}applyReadability(e){this.heroLuminance=Wu(e),this.rimApplied=Ku(e,nd,qu),this.rim.intensity=this.rimApplied?2.2:.6}readabilityReport(){return{heroLuminance:this.heroLuminance,floorLuminance:Wu(nd),rimApplied:this.rimApplied,threshold:qu}}configureFromSpeed(e){this.movement=Gl(e)}reset(e){let t=Au(e>>>0);this.world=ru(e>>>0);let n=Pu(t);this.world.hero.position={x:n.x,z:n.z},this.world.hero.facing=0,this.world.colliders=Mu(t),this.world.bounds=Nu(t),this.buildWalls(t),this.camSpring={pos:{x:n.x,z:n.z},vel:{x:0,z:0}},this.lastGoal={x:n.x,z:n.z},this.placeCamera(n.x,n.z),this.hero&&(this.hero.position.set(n.x,Ju,n.z),this.hero.rotation.set(0,this.world.hero.facing,0))}buildWalls(e){this.walls&&=(this.root.remove(this.walls),this.walls.geometry.dispose(),this.walls.material.dispose(),null);let t=[],n=e.width/2,r=e.height/2;for(let i=0;i<e.height;i++)for(let a=0;a<e.width;a++){let o=e.cells[i][a];Eu(o)&&t.push({x:a-n+.5,z:i-r+.5,wall:o===1})}let i=new oi(new yi(1,td,1),new la({roughness:.9,metalness:.02}),t.length),a=new Jt,o=new J(rd),s=new J(id);t.forEach((e,t)=>{a.makeTranslation(e.x,td/2,e.z),i.setMatrixAt(t,a),i.setColorAt(t,e.wall?o:s)}),i.instanceMatrix.needsUpdate=!0,i.instanceColor&&(i.instanceColor.needsUpdate=!0),this.walls=i,this.root.add(i)}arenaTick(e,t){this.world=gu(this.world,t,e,this.movement,this.dodge),this.bindHero(),this.juice?.update(e,this.world.hero),this.followCamera(e)}bindHero(){if(!this.hero)return;let e=this.world.hero;this.hero.position.set(e.position.x,Ju,e.position.z),this.hero.rotation.y=e.facing,this.shadowDisc.position.set(e.position.x,.02,e.position.z)}followCamera(e){this.framingTargets[0]=this.world.hero.position;let t=xu(this.framingTargets),n=this.world.hero,r=eu(n.speed/this.movement.maxSpeed,0,1),i={x:t.center.x+Math.sin(n.facing)*$u*r,z:t.center.z+Math.cos(n.facing)*$u*r};Ql(i,this.lastGoal)>=ed&&(this.lastGoal=i),this.camSpring=bu(this.camSpring,this.lastGoal,Qu,e);let a=eu(Yu+t.diagonal*1.1,Yu,Xu);Math.abs(a-this.frustumSize)>1e-4&&(this.frustumSize=a,this.updateFrustum()),this.placeCamera(Su(this.camSpring.pos.x),Su(this.camSpring.pos.z))}placeCamera(e,t){this.camera.position.set(e+this.camOffset.x,this.camOffset.y,t+this.camOffset.z),this.camera.lookAt(e,0,t)}updateFrustum(){let e=this.frustumSize/2;this.camera.left=-e*this.aspect,this.camera.right=e*this.aspect,this.camera.top=e,this.camera.bottom=-e,this.camera.updateProjectionMatrix()}resize(e,t){this.aspect=e/t,this.updateFrustum()}};function od(e){let t={getState:()=>e.getState(),input:t=>e.setApiInput(t),enterArena:()=>e.enterArena(),returnToForge:()=>e.returnToForge(),setSeed:t=>e.setSeed(t),loadArena:t=>e.loadArena(t),setManualStep:t=>e.setManualStep(t),step:(t,n)=>e.stepArena(t,n),readability:()=>e.readability(),setLoadout:(t,n)=>e.setLoadout(t,n),randomizeLoadout:()=>e.randomizeLoadout()};return window.__game=t,t}var sd=document.querySelector(`#canvas-wrap`),cd=document.querySelector(`#selectors`),ld=document.querySelector(`#stats`),ud=document.querySelector(`#hero-title`),dd=document.querySelector(`#hero-name`),fd=new iu(sd),pd=fd.forge,md=new ad;fd.scene.add(md.root),md.root.visible=!1,fd.arenaCamera=md.camera,fd.arenaResize=(e,t)=>md.resize(e,t),fd.juiceProvider=()=>md.juiceMarkers(),fd.readabilityProvider=()=>md.readabilityReport(),fd.onEnterArena=()=>{md.configureFromSpeed(kl(pd.state).speed),md.applyReadability(Ol.armor[pd.state.armor].color),md.reset(fd.seed),md.receiveHero(pd.hero),fd.arenaWorld=md.world,fd.setArenaStepper((e,t)=>{md.arenaTick(e,t),fd.arenaWorld=md.world}),md.root.visible=!0},fd.onReturnToForge=()=>{md.root.visible=!1,fd.arenaWorld=null};function hd(){let e={armor:`Armor Set`,melee:`Melee`,ranged:`Ranged`,partner:`Companion`,artifact:`Artifact`,look:`Origin`};Object.keys(Ol).forEach(t=>{let n=document.createElement(`section`);n.className=`selector`,n.innerHTML=`<div class="selector-header"><h2>${e[t]}</h2><span class="value" data-value="${t}"></span></div><div class="choice-row"><button type="button" data-dir="-1" data-slot="${t}">‹</button><button class="equip" type="button" data-dir="1" data-slot="${t}"></button><button type="button" data-dir="1" data-slot="${t}">›</button></div>`,cd.appendChild(n)}),cd.addEventListener(`click`,e=>{let t=e.target.closest(`button[data-slot]`);if(!t)return;let n=t.dataset.slot,r=Number(t.dataset.dir??1);pd.cycleSlot(n,r)})}function gd(){Object.keys(Ol).forEach(e=>{let t=Ol[e][pd.state[e]];document.querySelector(`[data-value="${e}"]`).textContent=t.emoji,document.querySelector(`.equip[data-slot="${e}"]`).innerHTML=`<span class="sigil">${t.emoji}</span><span>${t.name}</span>`}),ud.textContent=`${Ol.partner[pd.state.partner].title} ${Ol.armor[pd.state.armor].title} with ${Ol.ranged[pd.state.ranged].title}`,_d()}function _d(){let e=kl(pd.state);ld.innerHTML=Object.entries(e).map(([e,t])=>`<div class="stat-row"><span>${e}</span><span class="meter"><i style="width:${Math.min(100,t*12)}%"></i></span><b>${t}</b></div>`).join(``)}pd.onChange=gd;var vd=document.createElement(`button`);vd.id=`enter-arena`,vd.type=`button`,vd.className=`primary-button enter-arena`,vd.textContent=`Enter Arena ▶`,ld.insertAdjacentElement(`afterend`,vd),vd.addEventListener(`click`,()=>{window.__game?.enterArena()});var yd=document.createElement(`button`);yd.id=`back-to-forge`,yd.type=`button`,yd.className=`back-to-forge`,yd.textContent=`◀ Back to Forge`,document.querySelector(`#app`).appendChild(yd),yd.addEventListener(`click`,()=>{window.__game?.returnToForge()}),document.querySelector(`#randomize`).addEventListener(`click`,()=>{dd.value=pd.randomize()}),document.querySelector(`#photo-upload`).addEventListener(`change`,e=>{let t=e.target.files?.[0];t&&pd.applyPhotoColors(t)}),hd(),gd(),od(fd),fd.start();